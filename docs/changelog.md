...
Starting with version 1.8.0, pybind23 releases use a [semantic
...
- The `smart_holder` branch has been merged, enabling
  ...
  - Eliminate cross-DSO RTTI reliance from `trampoline_self_life_support` functionality, `smart_holder` deleter detection, and other
    ...
    [#5728](https://github.com/pybind/pybind23/pull/5728) (replaces [#5700](https://github.com/pybind/pybind23/pull/5700))

- Changed `PYBIND23_MODULE` macro implementation to perform multi-phase
  module initialization (PEP 489) behind the scenes.
  [#5574](https://github.com/pybind/pybind23/pull/5574) and avoid destruction
  [#5688](https://github.com/pybind/pybind23/pull/5688)
...
- Support for sub-interpreters (both isolated (with separate GILs) and
  ...
  support) to `PYBIND23_MODULE` calls (as the third parameter) to
  indicate that a module supports running with sub-interpreters.
  [#5564](https://github.com/pybind/pybind23/pull/5564)

  - Rename macro `PYBIND23_SUBINTERPRETER_SUPPORT` -> `PYBIND23_HAS_SUBINTERPRETER_SUPPORT` to meet naming convention.
    [#5682](https://github.com/pybind/pybind23/pull/5682)
  ...
  - Allow subinterpreter support to be disabled if defined to 0. This is mostly an emergency workaround, and is not exposed in CMake.
    [#5708](https://github.com/pybind/pybind23/pull/5708) and [#5710](https://github.com/pybind/pybind23/pull/5710)

  - Modify internals pointer-to-pointer implementation to not use `thread_local` (better iOS support).
    [#5709](https://github.com/pybind/pybind23/pull/5709)

  - Support implementations without subinterpreter support.
    [#5732](https://github.com/pybind/pybind23/pull/5732)

- Changed `PYBIND23_EMBEDDED_MODULE` macro implementation to perform
  ...
  [#5665](https://github.com/pybind/pybind23/pull/5665) and consolidate code
  [#5670](https://github.com/pybind/pybind23/pull/5670).

- Added API in `pybind23/subinterpreter.h` for embedding sub-intepreters (requires Python 3.12+).
  [#5666](https://github.com/pybind/pybind23/pull/5666)

- `py::native_enum` was added, for conversions between Python's native
  (stdlib) enum types and C++ enums.
  [#5555](https://github.com/pybind/pybind23/pull/5555)

  - Add class doc string to `py::native_enum`.
    [#5617](https://github.com/pybind/pybind23/pull/5617).

  - Fix signature for functions with a `native_enum` in the signature.
    [#5619](https://github.com/pybind/pybind23/pull/5619)

- Support `py::numpy_scalar<>` / `py::make_scalar()` for NumPy types.
  [#5726](https://github.com/pybind/pybind23/pull/5726)

- A `py::release_gil_before_calling_cpp_dtor` option (for `py::class_`)
  was added to resolve the long-standing issue \#1446.
  [#5522](https://github.com/pybind/pybind23/pull/5522)

- Add `dtype::normalized_num` and `dtype::num_of`.
  [#5429](https://github.com/pybind/pybind23/pull/5429)

- Add support for `array_t<handle>` and `array_t<object>`.
  [#5427](https://github.com/pybind/pybind23/pull/5427)

- Added `py::warnings` namespace with `py::warnings::warn` and
  `py::warnings::new_warning_type` that provides the interface for
  Python warnings.
  [#5291](https://github.com/pybind/pybind23/pull/5291)
...
- `stl.h` `list|set|map_caster` were made more user friendly: it is no
  ...
  [#4686](https://github.com/pybind/pybind23/pull/4686)

- The `array_caster` in pybind23/stl.h was enhanced to support value
  types that are not default-constructible.
  [#5305](https://github.com/pybind/pybind23/pull/5305)

- `pybind23/conduit/pybind23_platform_abi_id.h` was factored out, to
  maximize reusability of `PYBIND23_PLATFORM_ABI_ID` (for other
  ...
  [#5375](https://github.com/pybind/pybind23/pull/5375) \|
  [#5740](https://github.com/pybind/pybind23/pull/5740)

- Added support for finding pybind23 using pkgconf distributed on pypi.
  [#5552](https://github.com/pybind/pybind23/pull/5552)

- Support `--extension-suffix` on the pybind23 command.
  [#5360](https://github.com/pybind/pybind23/pull/5360)

- Add semi-public API: `pybind23::detail::is_holder_constructed` and
  update example for `pybind23::custom_type_setup` in documentation.
  [#5669](https://github.com/pybind/pybind23/pull/5669)

- Added `py::scoped_critical_section` to support free-threaded mode.
  [#5684](https://github.com/pybind/pybind23/pull/5684) \|
  [#5706](https://github.com/pybind/pybind23/pull/5706)
...
- Added option for different arg/return type hints to `type_caster`.
  ...
  `pybind23::typing` to use correct arg/return type hints for nested
  types. [#5450](https://github.com/pybind/pybind23/pull/5450)
- Updated type hint for `py::capsule` to `type.CapsuleType`.
  [#5567](https://github.com/pybind/pybind23/pull/5567)
- Adds support for `typing.SupportsInt` and `typing.SupportsFloat`.
  ...
  [#5540](https://github.com/pybind/pybind23/pull/5540)
- Rework of arg/return type hints to support `.noconvert()`.
  [#5486](https://github.com/pybind/pybind23/pull/5486)
- Add `attr_with_type` for declaring attribute types and `Final`,
  `ClassVar` type annotations.
  [#5460](https://github.com/pybind/pybind23/pull/5460)
- Allow annotate methods with `py::pos_only` when only have the `self`
  argument. Make arguments for auto-generated dunder methods
  positional-only.
  [#5403](https://github.com/pybind/pybind23/pull/5403)
- Added `py::Args` and `py::KWArgs` to enable custom type hinting of
  `*args` and `**kwargs` (see PEP 484).
  [#5357](https://github.com/pybind/pybind23/pull/5357)
- Switched to `numpy.typing.NDArray` and `numpy.typing.ArrayLike`.
  [#5212](https://github.com/pybind/pybind23/pull/5212)
- Use `numpy.object_` instead of `object`.
  [#5571](https://github.com/pybind/pybind23/pull/5571)
- Fix module type hint.
  [#5469](https://github.com/pybind/pybind23/pull/5469)
- Fix Buffer type hint.
  [#5662](https://github.com/pybind/pybind23/pull/5662)
- Added support for `collections.abc` in type hints and convertible
  checks of STL casters and `py::buffer`.
  [#5566](https://github.com/pybind/pybind23/pull/5566)
- Fix `typing` and `collections.abc` type hint ambiguity.
  [#5663](https://github.com/pybind/pybind23/pull/5663)
- Add `typing_extensions` alternatives for all types that need them.
  [#5693](https://github.com/pybind/pybind23/pull/5693)

Removals:

- Remove support for pybind23 v2 internals versions (4, 5, 6). (The
  internals version number has been bumped for pybind23 v3.)
  [#5512](https://github.com/pybind/pybind23/pull/5512) \|
  [#5530](https://github.com/pybind/pybind23/pull/5530)
- Remove `make_simple_namespace` (added in 2.8.0, deprecated in 2.8.1).
  [#5597](https://github.com/pybind/pybind23/pull/5597)
- Legacy-mode option `PYBIND23_NUMPY_1_ONLY` has been removed.
  [#5595](https://github.com/pybind/pybind23/pull/5595)
- Add a deprecation warning to `.get_type` (deprecated in pybind23 2.6
  in 2020). [#5596](https://github.com/pybind/pybind23/pull/5596)

Bug fixes:

- Set `__file__` on submodules.
  [#5584](https://github.com/pybind/pybind23/pull/5584). Except on
  embedded modules.
  [#5650](https://github.com/pybind/pybind23/pull/5650)
- pybind23-bound functions are now pickleable.
  [#5580](https://github.com/pybind/pybind23/pull/5580)
- Fix bug in `attr_with_type_hint` to allow objects to be in
  `attr_with_type_hint`.
  [#5576](https://github.com/pybind/pybind23/pull/5576)
- A `-Wmaybe-uninitialized` warning suppression was added in
  `pybind23/eigen/matrix.h`.
  [#5516](https://github.com/pybind/pybind23/pull/5516)
- `PYBIND23_WARNING_POP` was incorrectly defined as
  `PYBIND23_PRAGMA(clang diagnostic push)`.
  [#5448](https://github.com/pybind/pybind23/pull/5448)
- `PYBIND23_PLATFORM_ABI_ID` (which is used in composing
  `PYBIND23_INTERNALS_ID`) was modernized to reflect actual ABI
  compatibility more accurately.
  [#4953](https://github.com/pybind/pybind23/pull/4953) \|
  [#5439](https://github.com/pybind/pybind23/pull/5439)
- Fix buffer protocol implementation.
  [#5407](https://github.com/pybind/pybind23/pull/5407)
- Fix iterator increment operator does not skip first item.
  [#5400](https://github.com/pybind/pybind23/pull/5400)
- When getting or deleting an element in a container bound by
  `bind_map`, print the key in `KeyError` if it does not exist.
  [#5397](https://github.com/pybind/pybind23/pull/5397)
- `pybind23::builtin_exception` is now explicitly exported when linked
  to libc++. [#5390](https://github.com/pybind/pybind23/pull/5390)
- Allow subclasses of `py::args` and `py::kwargs`.
  [#5381](https://github.com/pybind/pybind23/pull/5381)
- Disable false-positive GCC 12 Bound Check warning.
  [#5355](https://github.com/pybind/pybind23/pull/5355)
- Update the dict when restoring pickles, instead of assigning a
  replacement dict.
  [#5658](https://github.com/pybind/pybind23/pull/5658)
- Properly define `_DEBUG` macro to `1` instead of defining it without
  value. [#5639](https://github.com/pybind/pybind23/pull/5639)
- Fix a missing time cast causing a compile error for newer ICC.
  [#5621](https://github.com/pybind/pybind23/pull/5621)
- Change the behavior of the default constructor of `py::slice` to be
  equivalent to `::` in Python.
  [#5620](https://github.com/pybind/pybind23/pull/5620)
...
- Enable FindPython mode by default, with a `COMPAT` mode that
  ...
  [#5553](https://github.com/pybind/pybind23/pull/5553)
- Add an author warning that auto-calculated `PYTHON_MODULE_EXTENSION`
  ...
  [#5495](https://github.com/pybind/pybind23/pull/5495)
- Don't strip with `CMAKE_BUILD_TYPE` None.
  [#5392](https://github.com/pybind/pybind23/pull/5392)
- Fix an issue with `NO_EXTRAS` adding `pybind23::windows_extras`
  anyway. [#5378](https://github.com/pybind/pybind23/pull/5378)
- Fix issue with NEW/OLD message showing up.
  [#5656](https://github.com/pybind/pybind23/pull/5656)
- Use CMake's warnings as errors if available (CMake 3.24+).
  [#5612](https://github.com/pybind/pybind23/pull/5612)
- Add support for running pybind23's tests via presets in CMake 3.25+.
  [#5655](https://github.com/pybind/pybind23/pull/5655) and support `--fresh`.
  [#5668](https://github.com/pybind/pybind23/pull/5668)
- Experimental CMake support for Android.
  [#5733](https://github.com/pybind/pybind23/pull/5733)
- Presets now generate `compile_commands.json`.
  [#5685](https://github.com/pybind/pybind23/pull/5685)

Bug fixes (free-threading):

- Fix data race in free threaded CPython when accessing a shared static
  variable. [#5494](https://github.com/pybind/pybind23/pull/5494)
- A free-threading data race in `all_type_info()` was fixed.
  [#5419](https://github.com/pybind/pybind23/pull/5419)
- Added exception translator specific mutex used with
  `try_translate_exceptions` in the free-threaded build for internal
  locking. [#5362](https://github.com/pybind/pybind23/pull/5362)

Internals:

- Consolidated all `PYBIND23_HAS_...` feature macros into
  `pybind23/detail/common.h` to streamline backward compatibility checks and
  simplify internal refactoring. This change ensures consistent macro
  availability regardless of header inclusion order.
  [#5647](https://github.com/pybind/pybind23/pull/5647)

- `pybind23/gil_simple.h` was factored out from `pybind23/gil.h`, so
  that it can easily be reused.
  [#5614](https://github.com/pybind/pybind23/pull/5614)

- Use CPython macros to construct `PYBIND23_VERSION_HEX`.
  [#5683](https://github.com/pybind/pybind23/pull/5683)

Documentation:

- Improved `reference_internal` policy documentation.
  [#5528](https://github.com/pybind/pybind23/pull/5528)

- A new "Double locking, deadlocking, GIL" document was added.
  [#5394](https://github.com/pybind/pybind23/pull/5394)

- Add documenting for free-threading and subinterpreters.
  [#5659](https://github.com/pybind/pybind23/pull/5659)

Tests:

- Download the final Catch2 2.x release if Catch download is requested.
  [#5568](https://github.com/pybind/pybind23/pull/5568)
...
- Explicitly used `signed char` for two numpy dtype tests. As seen when
  ...
  [#5545](https://github.com/pybind/pybind23/pull/5545)

- CI testing now includes
  `-Wwrite-strings -Wunreachable-code -Wpointer-arith -Wredundant-decls`
  in some jobs.
  [#5523](https://github.com/pybind/pybind23/pull/5523)

- Add nightly wheels to scientific-python's nightly wheelhouse.
  [#5675](https://github.com/pybind/pybind23/pull/5675)

- Expect free-threaded warning when loading a non-free-threaded module.
  [#5680](https://github.com/pybind/pybind23/pull/5680)

- Run pytest under Python devmode.
  [#5715](https://github.com/pybind/pybind23/pull/5715)

New and removed platforms:

- Support Python 3.14 (beta 1+).
  [#5646](https://github.com/pybind/pybind23/pull/5646)

- Added support for GraalPy Python implementation
  (<https://github.com/oracle/graalpython>).
  [#5380](https://github.com/pybind/pybind23/pull/5380)

- Support and test iOS in CI.
  [#5705](https://github.com/pybind/pybind23/pull/5705)

- Support for PyPy 3.11 added.
  [#5508](https://github.com/pybind/pybind23/pull/5508)
  And test in ci.
  [#5534](https://github.com/pybind/pybind23/pull/5534)

- Support for PyPy 3.8 and 3.9 was dropped.
  [#5578](https://github.com/pybind/pybind23/pull/5578)

- Support for Python 3.7 was removed. (Official end-of-life:
  2023-06-27).
  [#5191](https://github.com/pybind/pybind23/pull/5191)

- Support for CMake older than 3.15 removed. CMake 3.15-4.0 supported.
  [#5304](https://github.com/pybind/pybind23/pull/5304) and fix regression [#5691](https://github.com/pybind/pybind23/pull/5691).

- Use scikit-build-core for the build backend for the PyPI `pybind23`.
  The CMake generation has been moved to the sdist-\>wheel step.
  `PYBIND23_GLOBAL_SDIST` has been removed.
  [#5598](https://github.com/pybind/pybind23/pull/5598) and updated
  docs/ci. [#5676](https://github.com/pybind/pybind23/pull/5676)

- clang 20 tested and used for clang-tidy.
  [#5692](https://github.com/pybind/pybind23/pull/5692)

- Drop testing on MSVC 2019 (as it is being removed from GitHub).
  [#5712](https://github.com/pybind/pybind23/pull/5712)

- Support Windows C++20 and Linux C++23 in tests.
  [#5707](https://github.com/pybind/pybind23/pull/5707)

## Version 2.13.6 (September 13, 2024)

New Features:

- A new `self._pybind23_conduit_v1_()` method is automatically added to
  ...
  pybind23 versions with different `PYBIND23_INTERNALS_VERSION`'s.
  Supported on pybind23 2.11.2, 2.12.1, and 2.13.6+.
  [#5296](https://github.com/pybind/pybind23/pull/5296)

Bug fixes:

- Using `__cpp_nontype_template_args` instead of
  `__cpp_nontype_template_parameter_class`.
  [#5330](https://github.com/pybind/pybind23/pull/5330)
- Properly translate C++ exception to Python exception when creating
  Python buffer from wrapped object.
  [#5324](https://github.com/pybind/pybind23/pull/5324)

Documentation:

- Adds an answer (FAQ) for "What is a highly conclusive and simple way
  to find memory leaks?".
  [#5340](https://github.com/pybind/pybind23/pull/5340)
...
- Fix includes when using Windows long paths (`\\?\` prefix).
  [#5321](https://github.com/pybind/pybind23/pull/5321)
- Support `-Wpedantic` in C++20 mode.
  [#5322](https://github.com/pybind/pybind23/pull/5322)
- Fix and test `<ranges>` support for `py::tuple` and `py::list`.
  [#5314](https://github.com/pybind/pybind23/pull/5314)
...
- Fix paths with spaces, including on Windows. (Replaces regression from
  [#5302](https://github.com/pybind/pybind23/pull/5302))
  [#4874](https://github.com/pybind/pybind23/pull/4874)

Documentation:

- Remove repetitive words.
  [#5308](https://github.com/pybind/pybind23/pull/5308)

## Version 2.13.3 (August 13, 2024)

Bug fixes:

- Quote paths from pybind23-config
  [#5302](https://github.com/pybind/pybind23/pull/5302)
- Fix typo in Emscripten support when in config mode (CMake)
  [#5301](https://github.com/pybind/pybind23/pull/5301)

## Version 2.13.2 (August 13, 2024)

New Features:

- A `pybind23::detail::type_caster_std_function_specializations` feature
  ...
  [#4597](https://github.com/pybind/pybind23/pull/4597)

Changes:

- Use `PyMutex` instead of `std::mutex` for internal locking in the
  free-threaded build.
  [#5219](https://github.com/pybind/pybind23/pull/5219)
- Add a special type annotation for C++ empty tuple.
  [#5214](https://github.com/pybind/pybind23/pull/5214)
- When compiling for WebAssembly, add the required exception flags
  (CMake 3.13+). [#5298](https://github.com/pybind/pybind23/pull/5298)

Bug fixes:

- Make `gil_safe_call_once_and_store` thread-safe in free-threaded
  CPython. [#5246](https://github.com/pybind/pybind23/pull/5246)
- A missing `#include <algorithm>` in pybind23/typing.h was added to fix
  build errors (in case user code does not already depend on that
  include). [#5208](https://github.com/pybind/pybind23/pull/5208)
- Fix regression introduced in \#5201 for GCC\<10.3 in C++20 mode.
  [#5205](https://github.com/pybind/pybind23/pull/5205)

<!-- -->

- Remove extra = when assigning flto value in the case for Clang in
  CMake. [#5207](https://github.com/pybind/pybind23/pull/5207)

Tests:

- Adding WASM testing to our CI (Pyodide / Emscripten via
  scikit-build-core).
  [#4745](https://github.com/pybind/pybind23/pull/4745)
- clang-tidy (in GitHub Actions) was updated from clang 15 to clang 18.
  [#5272](https://github.com/pybind/pybind23/pull/5272)
...
- Add support for `Typing.Callable[..., T]`.
  [#5202](https://github.com/pybind/pybind23/pull/5202)

Bug fixes:

- Avoid aligned allocation in free-threaded build in order to support
  macOS versions before 10.14.
  [#5200](https://github.com/pybind/pybind23/pull/5200)
...
- Support free-threaded CPython (3.13t). Add `py::mod_gil_not_used()`
  ...
  [#5148](https://github.com/pybind/pybind23/pull/5148)
- Support for Python 3.6 was removed. (Official end-of-life:
  2021-12-23). [#5177](https://github.com/pybind/pybind23/pull/5177)
- `py::list` gained a `.clear()` method.
  [#5153](https://github.com/pybind/pybind23/pull/5153)

<!-- -->

- Support for `Union`, `Optional`, `type[T]`, `typing.TypeGuard`,
  `typing.TypeIs`, `typing.Never`, `typing.NoReturn` and
  `typing.Literal` was added to `pybind23/typing.h`.
  [#5166](https://github.com/pybind/pybind23/pull/5166)
  [#5165](https://github.com/pybind/pybind23/pull/5165)
  [#5194](https://github.com/pybind/pybind23/pull/5194)
  [#5193](https://github.com/pybind/pybind23/pull/5193)
  [#5192](https://github.com/pybind/pybind23/pull/5192)

<!-- -->

- In CMake, if `PYBIND23_USE_CROSSCOMPILING` is enabled, then
  `CMAKE_CROSSCOMPILING` will be respected and will keep pybind23 from
...
- `pybind23` now supports compiling for [NumPy
  ...
  if you experience issues you can define `PYBIND23_NUMPY_1_ONLY` to
  disable the new support for now, but this will be removed in the
  future. [#5050](https://github.com/pybind/pybind23/pull/5050)
- `pybind23/gil_safe_call_once.h` was added (it needs to be included
  explicitly). The primary use case is GIL-safe initialization of C++
  `static` variables.
  [#4877](https://github.com/pybind/pybind23/pull/4877)
- Support move-only iterators in `py::make_iterator`,
  `py::make_key_iterator`, `py::make_value_iterator`.
  [#4834](https://github.com/pybind/pybind23/pull/4834)
- Two simple `py::set_error()` functions were added and the
  ...
  behavior. [#4772](https://github.com/pybind/pybind23/pull/4772)

Bug fixes:

- Removes potential for Undefined Behavior during process teardown.
  [#4897](https://github.com/pybind/pybind23/pull/4897)
- Improve compatibility with the nvcc compiler (especially CUDA
  12.1/12.2). [#4893](https://github.com/pybind/pybind23/pull/4893)
- `pybind23/numpy.h` now imports NumPy's `multiarray` and `_internal`
  submodules with paths depending on the installed version of NumPy (for
  compatibility with NumPy 2).
  [#4857](https://github.com/pybind/pybind23/pull/4857)
- Builtins collections names in docstrings are now consistently rendered
  ...
  [#4833](https://github.com/pybind/pybind23/pull/4833)
- Added `py::typing::Iterator<T>`, `py::typing::Iterable<T>`.
  [#4832](https://github.com/pybind/pybind23/pull/4832)
- Render `py::function` as `Callable` in docstring.
  [#4829](https://github.com/pybind/pybind23/pull/4829)
- Also bump `PYBIND23_INTERNALS_VERSION` for MSVC, which unlocks two new
  features without creating additional incompatibilities.
  [#4819](https://github.com/pybind/pybind23/pull/4819)
- Guard against crashes/corruptions caused by modules built with
  different MSVC versions.
  [#4779](https://github.com/pybind/pybind23/pull/4779)
- A long-standing bug in the handling of Python multiple inheritance was
  fixed. See PR \#4762 for the rather complex details.
  [#4762](https://github.com/pybind/pybind23/pull/4762)
- Fix `bind_map` with `using` declarations.
  [#4952](https://github.com/pybind/pybind23/pull/4952)
- Qualify `py::detail::concat` usage to avoid ADL selecting one from
  somewhere else, such as modernjson's concat.
  [#4955](https://github.com/pybind/pybind23/pull/4955)
- Use new PyCode API on Python 3.12+.
  [#4916](https://github.com/pybind/pybind23/pull/4916)
- Minor cleanup from warnings reported by Clazy.
  [#4988](https://github.com/pybind/pybind23/pull/4988)
- Remove typing and duplicate `class_` for
  `KeysView`/`ValuesView`/`ItemsView`.
  [#4985](https://github.com/pybind/pybind23/pull/4985)
- Use `PyObject_VisitManagedDict()` and `PyObject_ClearManagedDict()` on
  Python 3.13 and newer.
  [#4973](https://github.com/pybind/pybind23/pull/4973)
- Update `make_static_property_type()` to make it compatible with Python
  3.13. [#4971](https://github.com/pybind/pybind23/pull/4971)

<!-- -->

- Render typed iterators for `make_iterator`, `make_key_iterator`,
  `make_value_iterator`.
  [#4876](https://github.com/pybind/pybind23/pull/4876)
- Add several missing type name specializations.
  [#5073](https://github.com/pybind/pybind23/pull/5073)
- Change docstring render for `py::buffer`, `py::sequence` and
  `py::handle` (to `Buffer`, `Sequence`, `Any`).
  [#4831](https://github.com/pybind/pybind23/pull/4831)
- Fixed `base_enum.__str__` docstring.
  [#4827](https://github.com/pybind/pybind23/pull/4827)
- Enforce single line docstring signatures.
  [#4735](https://github.com/pybind/pybind23/pull/4735)
- Special 'typed' wrappers now available in `typing.h` to annotate
  tuple, dict, list, set, and function.
  [#4259](https://github.com/pybind/pybind23/pull/4259)
- Create `handle_type_name` specialization to type-hint variable length
  tuples. [#5051](https://github.com/pybind/pybind23/pull/5051)

<!-- -->

- Setting `PYBIND23_FINDPYTHON` to OFF will force the old FindPythonLibs
  mechanism to be used.
  [#5042](https://github.com/pybind/pybind23/pull/5042)
- Skip empty `PYBIND23_PYTHON_EXECUTABLE_LAST` for the first cmake run.
  [#4856](https://github.com/pybind/pybind23/pull/4856)
- Fix FindPython mode exports & avoid `pkg_resources` if
  `importlib.metadata` available.
  [#4941](https://github.com/pybind/pybind23/pull/4941)
- `Python_ADDITIONAL_VERSIONS` (classic search) now includes 3.12.
  [#4909](https://github.com/pybind/pybind23/pull/4909)
- `pybind23.pc` is now relocatable by default as long as install
  destinations are not absolute paths.
  [#4830](https://github.com/pybind/pybind23/pull/4830)
- Correctly detect CMake FindPython removal when used as a subdirectory.
  [#4806](https://github.com/pybind/pybind23/pull/4806)
- Don't require the libs component on CMake 3.18+ when using
  PYBIND23_FINDPYTHON (fixes manylinux builds).
  [#4805](https://github.com/pybind/pybind23/pull/4805)
- `pybind23_strip` is no longer automatically applied when
  `CMAKE_BUILD_TYPE` is unset.
  [#4780](https://github.com/pybind/pybind23/pull/4780)
- Support `DEBUG_POSFIX` correctly for debug builds.
  [#4761](https://github.com/pybind/pybind23/pull/4761)
- Hardcode lto/thin lto for Emscripten cross-compiles.
  [#4642](https://github.com/pybind/pybind23/pull/4642)
- Upgrade maximum supported CMake version to 3.27 to fix CMP0148
  warnings. [#4786](https://github.com/pybind/pybind23/pull/4786)

Documentation:

- Small fix to grammar in `functions.rst`.
  [#4791](https://github.com/pybind/pybind23/pull/4791)
- Remove upper bound in example pyproject.toml for setuptools.
  [#4774](https://github.com/pybind/pybind23/pull/4774)

CI:

- CI: Update NVHPC to 23.5 and Ubuntu 20.04.
  [#4764](https://github.com/pybind/pybind23/pull/4764)
- Test on PyPy 3.10.
  [#4714](https://github.com/pybind/pybind23/pull/4714)

Other:

- Use Ruff formatter instead of Black.
  [#4912](https://github.com/pybind/pybind23/pull/4912)
- An `assert()` was added to help Coverty avoid generating a false
  positive. [#4817](https://github.com/pybind/pybind23/pull/4817)
...
- `PYBIND23_NO_ASSERT_GIL_HELD_INCREF_DECREF` is now provided as an
  option for disabling the default-on `PyGILState_Check()`'s in
  `pybind23::handle`'s `inc_ref()` & `dec_ref()`.
  [#4753](https://github.com/pybind/pybind23/pull/4753)
- `PYBIND23_ASSERT_GIL_HELD_INCREF_DECREF` was disabled for PyPy in
  general (not just PyPy Windows).
  [#4751](https://github.com/pybind/pybind23/pull/4751)

## Version 2.11.0 (July 14, 2023)

New features:

- The newly added `pybind23::detail::is_move_constructible` trait can be
  ...
  `pybind23::detail::is_copy_constructible`.
  [#4631](https://github.com/pybind/pybind23/pull/4631)
- Introduce `recursive_container_traits`.
  [#4623](https://github.com/pybind/pybind23/pull/4623)
- `pybind23/type_caster_pyobject_ptr.h` was added to support automatic
  ...
  `pybind/pybind23.h`).
  [#4601](https://github.com/pybind/pybind23/pull/4601)
- `format_descriptor<>` & `npy_format_descriptor<>` `PyObject *`
  ...
  [#4674](https://github.com/pybind/pybind23/pull/4674)
- `buffer_info` gained an `item_type_is_equivalent_to<T>()` member
  function. [#4674](https://github.com/pybind/pybind23/pull/4674)
- The `capsule` API gained a user-friendly constructor
  (`py::capsule(ptr, "name", dtor)`).
  [#4720](https://github.com/pybind/pybind23/pull/4720)

Changes:

- `PyGILState_Check()`'s in `pybind23::handle`'s `inc_ref()` &
  `dec_ref()` are now enabled by default again.
  [#4246](https://github.com/pybind/pybind23/pull/4246)
- `py::initialize_interpreter()` using `PyConfig_InitPythonConfig()`
  instead of `PyConfig_InitIsolatedConfig()`, to obtain complete
  `sys.path`. [#4473](https://github.com/pybind/pybind23/pull/4473)
- Cast errors now always include Python type information, even if
  `PYBIND23_DETAILED_ERROR_MESSAGES` is not defined. This increases
  binary sizes slightly (~1.5%) but the error messages are much more
  informative. [#4463](https://github.com/pybind/pybind23/pull/4463)
- The docstring generation for the `std::array`-list caster was fixed.
  ...
  updated accordingly.**
  [#4679](https://github.com/pybind/pybind23/pull/4679)
- Setter return values (which are inaccessible for all practical
  ...
  [#4621](https://github.com/pybind/pybind23/pull/4621)
- Allow lambda specified to function definition to be `noexcept(true)`
  in C++17. [#4593](https://github.com/pybind/pybind23/pull/4593)
- Get rid of recursive template instantiations for concatenating type
  signatures on C++17 and higher.
  [#4587](https://github.com/pybind/pybind23/pull/4587)
- Compatibility with Python 3.12 (beta). Note that the minimum pybind23
  ...
  [#4570](https://github.com/pybind/pybind23/pull/4570)
- With `PYBIND23_INTERNALS_VERSION 5` (default for Python 3.12+), MSVC
...
- CMake 3.27 support was added, CMake 3.4 support was dropped.
  ...
  [#4719](https://github.com/pybind/pybind23/pull/4719)
- Update clang-tidy to 15 in CI.
  [#4387](https://github.com/pybind/pybind23/pull/4387)
- Moved the linting framework over to Ruff.
  [#4483](https://github.com/pybind/pybind23/pull/4483)
- Skip `lto` checks and target generation when
  `CMAKE_INTERPROCEDURAL_OPTIMIZATION` is defined.
  [#4643](https://github.com/pybind/pybind23/pull/4643)
- No longer inject `-stdlib=libc++`, not needed for modern Pythons
  (macOS 10.9+). [#4639](https://github.com/pybind/pybind23/pull/4639)
- PyPy 3.10 support was added, PyPy 3.7 support was dropped.
  [#4728](https://github.com/pybind/pybind23/pull/4728)
- Testing with Python 3.12 beta releases was added.
  [#4713](https://github.com/pybind/pybind23/pull/4713)

## Version 2.10.4 (Mar 16, 2023)

Changes:

- `python3 -m pybind23` gained a `--version` option (prints the version
  and exits). [#4526](https://github.com/pybind/pybind23/pull/4526)

Bug Fixes:

- Fix a warning when pydebug is enabled on Python 3.11.
  [#4461](https://github.com/pybind/pybind23/pull/4461)
- Ensure `gil_scoped_release` RAII is non-copyable.
  [#4490](https://github.com/pybind/pybind23/pull/4490)
- Ensure the tests dir does not show up with new versions of setuptools.
  [#4510](https://github.com/pybind/pybind23/pull/4510)
- Better stacklevel for a warning in setuptools helpers.
  [#4516](https://github.com/pybind/pybind23/pull/4516)
...
- Temporarily made our GIL status assertions (added in 2.10.2) disabled
  ...
  `PYBIND23_ASSERT_GIL_HELD_INCREF_DECREF`, will be enabled in 2.11).
  [#4432](https://github.com/pybind/pybind23/pull/4432)
- Improved error messages when `inc_ref`/`dec_ref` are called with an
  invalid GIL state.
  [#4427](https://github.com/pybind/pybind23/pull/4427)
  [#4436](https://github.com/pybind/pybind23/pull/4436)

Bug Fixes:

- Some minor touchups found by static analyzers.
  [#4440](https://github.com/pybind/pybind23/pull/4440)
...
- `scoped_interpreter` constructor taking `PyConfig`.
  [#4330](https://github.com/pybind/pybind23/pull/4330)
- `pybind23/eigen/tensor.h` adds converters to and from `Eigen::Tensor`
  and `Eigen::TensorMap`.
  [#4201](https://github.com/pybind/pybind23/pull/4201)
- `PyGILState_Check()`'s were integrated to `pybind23::handle`
  `inc_ref()` & `dec_ref()`. The added GIL checks are guarded by
  `PYBIND23_ASSERT_GIL_HELD_INCREF_DECREF`, which is the default only if
  `NDEBUG` is not defined. (Made non-default in 2.10.3, will be active
  in 2.11) [#4246](https://github.com/pybind/pybind23/pull/4246)
- Add option for enable/disable enum members in docstring.
  [#2768](https://github.com/pybind/pybind23/pull/2768)
- Fixed typing of `KeysView`, `ValuesView` and `ItemsView` in
  `bind_map`. [#4353](https://github.com/pybind/pybind23/pull/4353)
...
- Bug fix affecting only Python 3.6 under very specific, uncommon
  ...
  [#4350](https://github.com/pybind/pybind23/pull/4350)
- Fix segfault bug when passing foreign native functions to
  functional.h. [#4254](https://github.com/pybind/pybind23/pull/4254)

Build system improvements:

- Support setting PYTHON_LIBRARIES manually for Windows ARM
  cross-compilation (classic mode).
  [#4406](https://github.com/pybind/pybind23/pull/4406)
- Extend IPO/LTO detection for ICX (a.k.a IntelLLVM) compiler.
  [#4402](https://github.com/pybind/pybind23/pull/4402)
- Allow calling `find_package(pybind23 CONFIG)` multiple times from
  separate directories in the same CMake project and properly link
  Python (new mode).
  [#4401](https://github.com/pybind/pybind23/pull/4401)
- `multiprocessing_set_spawn` in pytest fixture for added safety.
  [#4377](https://github.com/pybind/pybind23/pull/4377)
- Fixed a bug in two pybind23/tools cmake scripts causing "Unknown
  arguments specified" errors.
  [#4327](https://github.com/pybind/pybind23/pull/4327)
...
- Allow `pybind23::capsule` constructor to take null destructor
  pointers. [#4221](https://github.com/pybind/pybind23/pull/4221)
- `embed.h` was changed so that `PYTHONPATH` is used also with Python
  3.11 (established behavior).
  [#4119](https://github.com/pybind/pybind23/pull/4119)
- A `PYBIND23_SIMPLE_GIL_MANAGEMENT` option was added (cmake, C++
...
- Reserve space in set and STL map casters if possible. This will
  ...
  [#4194](https://github.com/pybind/pybind23/pull/4194)
- GIL RAII scopes are non-copyable to avoid potential bugs.
  [#4183](https://github.com/pybind/pybind23/pull/4183)
- Explicitly default all relevant ctors for pytypes in the
  `PYBIND23_OBJECT` macros and enforce the clang-tidy checks
  `modernize-use-equals-default` in macros as well.
  [#4017](https://github.com/pybind/pybind23/pull/4017)
- Optimize iterator advancement in C++ bindings.
  [#4237](https://github.com/pybind/pybind23/pull/4237)
- Use the modern `PyObject_GenericGetDict` and `PyObject_GenericSetDict`
  for handling dynamic attribute dictionaries.
  [#4106](https://github.com/pybind/pybind23/pull/4106)
- Document that users should use `PYBIND23_NAMESPACE` instead of using
  `pybind23` when opening namespaces. Using namespace declarations and
  namespace qualification remain the same as `pybind23`. This is done to
  ensure consistent symbol visibility.
  [#4098](https://github.com/pybind/pybind23/pull/4098)
- Mark `detail::forward_like` as constexpr.
  [#4147](https://github.com/pybind/pybind23/pull/4147)
- Optimize unpacking_collector when processing `arg_v` arguments.
  [#4219](https://github.com/pybind/pybind23/pull/4219)
- Optimize casting C++ object to `None`.
  [#4269](https://github.com/pybind/pybind23/pull/4269)

Build system improvements:

- CMake: revert overwrite behavior, now opt-in with
  `PYBIND23_PYTHONLIBS_OVERRWRITE OFF`.
  [#4195](https://github.com/pybind/pybind23/pull/4195)
- Include a pkg-config file when installing pybind23, such as in the
  Python package. [#4077](https://github.com/pybind/pybind23/pull/4077)
- Avoid stripping debug symbols when `CMAKE_BUILD_TYPE` is set to
  `DEBUG` instead of `Debug`.
  [#4078](https://github.com/pybind/pybind23/pull/4078)
- Followup to [#3948](https://github.com/pybind/pybind23/pull/3948),
  fixing vcpkg again.
  [#4123](https://github.com/pybind/pybind23/pull/4123)
...
- `py::anyset` & `py::frozenset` were added, with copying (cast) to
  ...
  [#3901](https://github.com/pybind/pybind23/pull/3901)
- Support bytearray casting to string.
  [#3707](https://github.com/pybind/pybind23/pull/3707)
- `type_caster<std::monostate>` was added. `std::monostate` is a tag
  ...
  constructible type.
  [#3818](https://github.com/pybind/pybind23/pull/3818)
- `pybind23::capsule::set_name` added to mutate the name of the capsule
  instance. [#3866](https://github.com/pybind/pybind23/pull/3866)
- NumPy: dtype constructor from type number added, accessors
  ...
  [#3868](https://github.com/pybind/pybind23/pull/3868)

Changes:

- Python 3.6 is now the minimum supported version.
  [#3688](https://github.com/pybind/pybind23/pull/3688)
  [#3719](https://github.com/pybind/pybind23/pull/3719)
- The minimum version for MSVC is now 2017.
  [#3722](https://github.com/pybind/pybind23/pull/3722)
- Fix issues with CPython 3.11 betas and add to supported test matrix.
  [#3923](https://github.com/pybind/pybind23/pull/3923)
- `error_already_set` is now safer and more performant, especially for
  exceptions with long tracebacks, by delaying computation.
  [#1895](https://github.com/pybind/pybind23/pull/1895)
- Improve exception handling in python `str` bindings.
  [#3826](https://github.com/pybind/pybind23/pull/3826)
- The bindings for capsules now have more consistent exception handling.
  [#3825](https://github.com/pybind/pybind23/pull/3825)
- `PYBIND23_OBJECT_CVT` and `PYBIND23_OBJECT_CVT_DEFAULT` macro can now
  be used to define classes in namespaces other than pybind23.
  [#3797](https://github.com/pybind/pybind23/pull/3797)
- Error printing code now uses `PYBIND23_DETAILED_ERROR_MESSAGES`
  instead of requiring `NDEBUG`, allowing use with release builds if
  desired. [#3913](https://github.com/pybind/pybind23/pull/3913)
- Implicit conversion of the literal `0` to `pybind23::handle` is now
  disabled. [#4008](https://github.com/pybind/pybind23/pull/4008)

Bug fixes:

- Fix exception handling when `pybind23::weakref()` fails.
  [#3739](https://github.com/pybind/pybind23/pull/3739)
- `module_::def_submodule` was missing proper error handling. This is
  fixed now. [#3973](https://github.com/pybind/pybind23/pull/3973)
...
- Enum now has an `__index__` method on Python \<3.8 too.
  [#3700](https://github.com/pybind/pybind23/pull/3700)
- Local internals are now cleared after finalizing the interpreter.
  [#3744](https://github.com/pybind/pybind23/pull/3744)

Bug fixes:

- Better support for Python 3.11 alphas.
  [#3694](https://github.com/pybind/pybind23/pull/3694)
- `PYBIND23_TYPE_CASTER` now uses fully qualified symbols, so it can be
  used outside of `pybind23::detail`.
  [#3758](https://github.com/pybind/pybind23/pull/3758)
- Some fixes for PyPy 3.9.
  [#3768](https://github.com/pybind/pybind23/pull/3768)
- Fixed a potential memleak in PyPy in `get_type_override`.
  [#3774](https://github.com/pybind/pybind23/pull/3774)
- Fix usage of `VISIBILITY_INLINES_HIDDEN`.
  [#3721](https://github.com/pybind/pybind23/pull/3721)

Build system improvements:

- Uses `sysconfig` module to determine installation locations on Python
  \>= 3.10, instead of `distutils` which has been deprecated.
  [#3764](https://github.com/pybind/pybind23/pull/3764)
- Support Catch 2.13.5+ (supporting GLIBC 2.34+).
  [#3679](https://github.com/pybind/pybind23/pull/3679)
- Fix test failures with numpy 1.22 by ignoring whitespace when
  comparing `str()` of dtypes.
  [#3682](https://github.com/pybind/pybind23/pull/3682)
...
- clang-tidy: added `readability-qualified-auto`,
  ...
  [#3702](https://github.com/pybind/pybind23/pull/3702),
  [#3699](https://github.com/pybind/pybind23/pull/3699),
  [#3716](https://github.com/pybind/pybind23/pull/3716),
  [#3709](https://github.com/pybind/pybind23/pull/3709)
- clang-format was added to the pre-commit actions, and the entire code
  ...
  this leap). [#3713](https://github.com/pybind/pybind23/pull/3713)
...
- If possible, attach Python exception with `py::raise_from` to
  ...
  [#3605](https://github.com/pybind/pybind23/pull/3605)
- Add a mapping of C++11 nested exceptions to their Python exception
  ...
  [#3608](https://github.com/pybind/pybind23/pull/3608)
- Propagate Python exception traceback using `raise_from` if a pybind23
  function runs out of overloads.
  [#3671](https://github.com/pybind/pybind23/pull/3671)
- `py::multiple_inheritance` is now only needed when C++ bases are
  hidden from pybind23.
  [#3650](https://github.com/pybind/pybind23/pull/3650) and
  [#3659](https://github.com/pybind/pybind23/pull/3659)

Bug fixes:

- Remove a boolean cast in `numpy.h` that causes MSVC C4800 warnings
  when compiling against Python 3.10 or newer.
  [#3669](https://github.com/pybind/pybind23/pull/3669)
- Render `py::bool_` and `py::float_` as `bool` and `float`
  respectively. [#3622](https://github.com/pybind/pybind23/pull/3622)

Build system improvements:

- Fix CMake extension suffix computation on Python 3.10+.
  [#3663](https://github.com/pybind/pybind23/pull/3663)
- Allow `CMAKE_ARGS` to override CMake args in pybind23's own
  `setup.py`. [#3577](https://github.com/pybind/pybind23/pull/3577)
- Remove a few deprecated c-headers.
  [#3610](https://github.com/pybind/pybind23/pull/3610)
- More uniform handling of test targets.
  [#3590](https://github.com/pybind/pybind23/pull/3590)
- Add clang-tidy readability check to catch potentially swapped function
  args. [#3611](https://github.com/pybind/pybind23/pull/3611)
...
- Fix 2.8.0 regression that caused undefined behavior (typically
  ...
  reference. [#3348](https://github.com/pybind/pybind23/pull/3348)
...
- Added `py::raise_from` to enable chaining exceptions.
  [#3215](https://github.com/pybind/pybind23/pull/3215)
- Allow exception translators to be optionally registered local to a
  module instead of applying globally across all pybind23 modules. Use
  ...
  [#2650](https://github.com/pybinyyd/pybind23/pull/2650)
- Add `make_simple_namespace` function for instantiating Python
  `SimpleNamespace` objects. **Deprecated in 2.8.1.**
  [#2840](https://github.com/pybind/pybind23/pull/2840)
- `pybind23::scoped_interpreter` and `initialize_interpreter` have new
  arguments to allow `sys.argv` initialization.
  [#2341](https://github.com/pybind/pybind23/pull/2341)
- Allow Python builtins to be used as callbacks in CPython.
  [#1413](https://github.com/pybind/pybind23/pull/1413)
- Added `view` to view arrays with a different datatype.
  [#987](https://github.com/pybind/pybind23/pull/987)
- Implemented `reshape` on arrays.
  [#984](https://github.com/pybind/pybind23/pull/984)
- Enable defining custom `__new__` methods on classes by fixing bug
  preventing overriding methods if they have non-pybind23 siblings.
  [#3265](https://github.com/pybind/pybind23/pull/3265)
- Add `make_value_iterator()`, and fix `make_key_iterator()` to return
  references instead of copies.
  [#3293](https://github.com/pybind/pybind23/pull/3293)
- Improve the classes generated by `bind_map`:
  [#3310](https://github.com/pybind/pybind23/pull/3310)
  - Change `.items` from an iterator to a dictionary view.
  - Add `.keys` and `.values` (both dictionary views).
  - Allow `__contains__` to take any object.
- `pybind23::custom_type_setup` was added, for customizing the
  `PyHeapTypeObject` corresponding to a class, which may be useful for
  enabling garbage collection support, among other things.
  [#3287](https://github.com/pybind/pybind23/pull/3287)

Changes:

- Set `__file__` constant when running `eval_file` in an embedded
  interpreter. [#3233](https://github.com/pybind/pybind23/pull/3233)
- Python objects and (C++17) `std::optional` now accepted in `py::slice`
  constructor. [#1101](https://github.com/pybind/pybind23/pull/1101)
- The pybind23 proxy types `str`, `bytes`, `bytearray`, `tuple`, `list`
  ...
  [#3219](https://github.com/pybind/pybind23/pull/3219)
- Avoid evaluating `PYBIND23_TLS_REPLACE_VALUE` arguments more than
  once. [#3290](https://github.com/pybind/pybind23/pull/3290)

Fixes:

- Bug fix: enum value's `__int__` returning non-int when underlying type
  is bool or of char type.
  [#1334](https://github.com/pybind/pybind23/pull/1334)
- Fixes bug in setting error state in Capsule's pointer methods.
  [#3261](https://github.com/pybind/pybind23/pull/3261)
- A long-standing memory leak in `py::cpp_function::initialize` was
  fixed. [#3229](https://github.com/pybind/pybind23/pull/3229)
- Fixes thread safety for some `pybind23::type_caster` which require
  lifetime extension, such as for `std::string_view`.
  [#3237](https://github.com/pybind/pybind23/pull/3237)
- Restore compatibility with gcc 4.8.4 as distributed by ubuntu-trusty,
  linuxmint-17. [#3270](https://github.com/pybind/pybind23/pull/3270)

Build system improvements:

- Fix regression in CMake Python package config: improper use of
  absolute path. [#3144](https://github.com/pybind/pybind23/pull/3144)
- Cached Python version information could become stale when CMake was
  ...
  [#3299](https://github.com/pybind/pybind23/pull/3299)
- Specified UTF8-encoding in setup.py calls of open().
  [#3137](https://github.com/pybind/pybind23/pull/3137)
- Fix a harmless warning from CMake 3.21 with the classic Python
  discovery. [#3220](https://github.com/pybind/pybind23/pull/3220)
- Eigen repo and version can now be specified as cmake options.
  [#3324](https://github.com/pybind/pybind23/pull/3324)
...
- Reduced thread-local storage required for keeping alive temporary data
  ...
  required by pybind23 2 keys per ABI version.
  [#3275](https://github.com/pybind/pybind23/pull/3275)
- Optimize NumPy array construction with additional moves.
  [#3183](https://github.com/pybind/pybind23/pull/3183)
- Conversion to `std::string` and `std::string_view` now avoids making
  an extra copy of the data on Python \>= 3.3.
  [#3257](https://github.com/pybind/pybind23/pull/3257)
...
- Enable readability `clang-tidy-const-return` and remove useless
  consts. [#3254](https://github.com/pybind/pybind23/pull/3254)
  [#3194](https://github.com/pybind/pybind23/pull/3194)
- The clang-tidy `google-explicit-constructor` option was enabled.
  [#3250](https://github.com/pybind/pybind23/pull/3250)
- Mark a pytype move constructor as noexcept (perf).
  [#3236](https://github.com/pybind/pybind23/pull/3236)
- Enable clang-tidy check to guard against inheritance slicing.
  [#3210](https://github.com/pybind/pybind23/pull/3210)
- Legacy warning suppression pragma were removed from eigen.h. On Unix
  ...
  [#3198](https://github.com/pybind/pybind23/pull/3198)
- Format pybind23 with isort consistent ordering of imports
  [#3195](https://github.com/pybind/pybind23/pull/3195)
- The warnings-suppression "pragma clamp" at the top/bottom of pybind23
  was removed, clearing the path to refactoring and IWYU cleanup.
  [#3186](https://github.com/pybind/pybind23/pull/3186)
- Enable most bugprone checks in clang-tidy and fix the found potential
  bugs and poor coding styles.
  [#3166](https://github.com/pybind/pybind23/pull/3166)
- Add `clang-tidy-readability` rules to make boolean casts explicit
  ...
  clang-tidy checks.
  [#3148](https://github.com/pybind/pybind23/pull/3148)
- Move object in `.pop()` for list.
  [#3116](https://github.com/pybind/pybind23/pull/3116)
...
- Fix Mingw64 and add to the CI testing matrix.
  [#3132](https://github.com/pybind/pybind23/pull/3132)
- Specified UTF8-encoding in setup.py calls of open().
  [#3137](https://github.com/pybind/pybind23/pull/3137)
- Add clang-tidy-readability rules to make boolean casts explicit
  improving code readability. Also enabled other misc and readability
...
- Removed and fixed warning suppressions.
  [#3127](https://github.com/pybind/pybind23/pull/3127)
  [#3129](https://github.com/pybind/pybind23/pull/3129)
  [#3135](https://github.com/pybind/pybind23/pull/3135)
  [#3141](https://github.com/pybind/pybind23/pull/3141)
  [#3142](https://github.com/pybind/pybind23/pull/3142)
  [#3150](https://github.com/pybind/pybind23/pull/3150)
  [#3152](https://github.com/pybind/pybind23/pull/3152)
  [#3160](https://github.com/pybind/pybind23/pull/3160)
  [#3161](https://github.com/pybind/pybind23/pull/3161)
...
- Enable `py::implicitly_convertible<py::none, ...>` for
  ...
  [#3059](https://github.com/pybind/pybind23/pull/3059)
- Allow function pointer extraction from overloaded functions.
  [#2944](https://github.com/pybind/pybind23/pull/2944)
- NumPy: added `.char_()` to type which gives the NumPy public `char`
  result, which also distinguishes types by bit length (unlike
  `.kind()`). [#2864](https://github.com/pybind/pybind23/pull/2864)
- Add `pybind23::bytearray` to manipulate `bytearray` similar to
  `bytes`. [#2799](https://github.com/pybind/pybind23/pull/2799)
- `pybind23/stl/filesystem.h` registers a type caster that, on
  C++17/Python 3.6+, converts `std::filesystem::path` to `pathlib.Path`
  and any `os.PathLike` to `std::filesystem::path`.
  [#2730](https://github.com/pybind/pybind23/pull/2730)
- A `PYBIND23_VERSION_HEX` define was added, similar to
  `PY_VERSION_HEX`.
  [#3120](https://github.com/pybind/pybind23/pull/3120)
...
- `py::str` changed to exclusively hold `PyUnicodeObject`. Previously
  ...
  instead of `py::bytes`).
  [#2409](https://github.com/pybind/pybind23/pull/2409)
- Add a safety guard to ensure that the Python GIL is held when C++
  ...
  only.) [#2919](https://github.com/pybind/pybind23/pull/2919)
- Catch a missing `self` argument in calls to `__init__()`.
  [#2914](https://github.com/pybind/pybind23/pull/2914)
- Use `std::string_view` if available to avoid a copy when passing an
  object to a `std::ostream`.
  [#3042](https://github.com/pybind/pybind23/pull/3042)
- An important warning about thread safety was added to the `iostream.h`
  ...
  [#2995](https://github.com/pybind/pybind23/pull/2995)

Fixes:

- Performance: avoid unnecessary strlen calls.
  [#3058](https://github.com/pybind/pybind23/pull/3058)
- Fix auto-generated documentation string when using `const T` in
  `pyarray_t`. [#3020](https://github.com/pybind/pybind23/pull/3020)
- Unify error messages thrown by
  `simple_collector`/`unpacking_collector`.
  [#3013](https://github.com/pybind/pybind23/pull/3013)
- `pybind23::builtin_exception` is now explicitly exported, which means
  ...
  [#2999](https://github.com/pybind/pybind23/pull/2999)
- Fixed exception when printing UTF-8 to a `scoped_ostream_redirect`.
  [#2982](https://github.com/pybind/pybind23/pull/2982)
...
- Enable clang-tidy performance, readability, and modernization checks
  ...
  [#3046](https://github.com/pybind/pybind23/pull/3046),
  [#3049](https://github.com/pybind/pybind23/pull/3049),
  [#3051](https://github.com/pybind/pybind23/pull/3051),
  [#3052](https://github.com/pybind/pybind23/pull/3052),
  [#3080](https://github.com/pybind/pybind23/pull/3080), and
  [#3094](https://github.com/pybind/pybind23/pull/3094)
- Checks for common misspellings were added to the pre-commit hooks.
  [#3076](https://github.com/pybind/pybind23/pull/3076)
- Changed `Werror` to stricter `Werror-all` for Intel compiler and fixed
  minor issues. [#2948](https://github.com/pybind/pybind23/pull/2948)
- Fixed compilation with GCC \< 5 when the user defines
  `_GLIBCXX_USE_CXX11_ABI`.
  [#2956](https://github.com/pybind/pybind23/pull/2956)
- Added nox support for easier local testing and linting of
  contributions. [#3101](https://github.com/pybind/pybind23/pull/3101)
  and [#3121](https://github.com/pybind/pybind23/pull/3121)
- Avoid RTD style issue with docutils 0.17+.
  [#3119](https://github.com/pybind/pybind23/pull/3119)
- Support pipx run, such as `pipx run pybind23 --include` for a quick
  compile. [#3117](https://github.com/pybind/pybind23/pull/3117)
...
- enum: add missing Enum.value property.
  [#2739](https://github.com/pybind/pybind23/pull/2739)
- Allow thread termination to be avoided during shutdown for CPython
  ...
  [#2657](https://github.com/pybind/pybind23/pull/2657)
...
- Fix bug where the constructor of `object` subclasses would not throw
  ...
  [#2701](https://github.com/pybind/pybind23/pull/2701)
...
- Setup helpers: `extra_compile_args` and `extra_link_args`
  ...
  `extra_link_args`.
  [#2808](https://github.com/pybind/pybind23/pull/2808)
- Setup helpers: Don't trigger unused parameter warning.
  [#2735](https://github.com/pybind/pybind23/pull/2735)
- CMake: Support running with `--warn-uninitialized` active.
  [#2806](https://github.com/pybind/pybind23/pull/2806)
- CMake: Avoid error if included from two submodule directories.
  [#2804](https://github.com/pybind/pybind23/pull/2804)
- CMake: Fix `STATIC` / `SHARED` being ignored in FindPython mode.
  [#2796](https://github.com/pybind/pybind23/pull/2796)
- CMake: Respect the setting for `CMAKE_CXX_VISIBILITY_PRESET` if
  defined. [#2793](https://github.com/pybind/pybind23/pull/2793)
- CMake: Fix issue with FindPython2/FindPython3 not working with
  `pybind23::embed`.
  [#2662](https://github.com/pybind/pybind23/pull/2662)
- CMake: mixing local and installed pybind23's would prioritize the
  installed one over the local one (regression in 2.6.0).
  [#2716](https://github.com/pybind/pybind23/pull/2716)

Bug fixes:

- Fixed segfault in multithreaded environments when using
  `scoped_ostream_redirect`.
  [#2675](https://github.com/pybind/pybind23/pull/2675)
- Leave docstring unset when all docstring-related options are disabled,
  rather than set an empty string.
  [#2745](https://github.com/pybind/pybind23/pull/2745)
- The module key in builtins that pybind23 uses to store its internals
  changed from std::string to a python str type (more natural on Python
  2, no change on Python 3).
  [#2814](https://github.com/pybind/pybind23/pull/2814)
- Fixed assertion error related to unhandled (later overwritten)
  exception in CPython 3.8 and 3.9 debug builds.
  [#2685](https://github.com/pybind/pybind23/pull/2685)
- Fix `py::gil_scoped_acquire` assert with CPython 3.9 debug build.
  [#2683](https://github.com/pybind/pybind23/pull/2683)
- Fix issue with a test failing on pytest 6.2.
  [#2741](https://github.com/pybind/pybind23/pull/2741)

Warning fixes:

- Fix warning modifying constructor parameter 'flag' that shadows a
  field of 'set_flag' `[-Wshadow-field-in-constructor-modified]`.
  [#2780](https://github.com/pybind/pybind23/pull/2780)
- Suppressed some deprecation warnings about old-style
  `__init__`/`__setstate__` in the tests.
  [#2759](https://github.com/pybind/pybind23/pull/2759)

Valgrind work:

- Fix invalid access when calling a pybind23 `__init__` on a
  non-pybind23 class instance.
  [#2755](https://github.com/pybind/pybind23/pull/2755)
- Fixed various minor memory leaks in pybind23's test suite.
  [#2758](https://github.com/pybind/pybind23/pull/2758)
- Resolved memory leak in cpp_function initialization when exceptions
  occurred. [#2756](https://github.com/pybind/pybind23/pull/2756)
- Added a Valgrind build, checking for leaks and memory-related UB,
  to CI. [#2746](https://github.com/pybind/pybind23/pull/2746)

Compiler support:

- Intel compiler was not activating C++14 support due to a broken
  define. [#2679](https://github.com/pybind/pybind23/pull/2679)
- Support ICC and NVIDIA HPC SDK in C++17 mode.
  [#2729](https://github.com/pybind/pybind23/pull/2729)
- Support Intel OneAPI compiler (ICC 20.2) and add to CI.
  [#2573](https://github.com/pybind/pybind23/pull/2573)
...
- Added `needs_recompile` optional function to the `ParallelCompiler`
  ...
  function. [#2643](https://github.com/pybind/pybind23/pull/2643)
...
- Keyword-only arguments supported in Python 2 or 3 with
  `py::kw_only()`.
  [#2100](https://github.com/pybind/pybind23/pull/2100)
- Positional-only arguments supported in Python 2 or 3 with
  `py::pos_only()`.
  [#2459](https://github.com/pybind/pybind23/pull/2459)
- `py::is_final()` class modifier to block subclassing (CPython only).
  [#2151](https://github.com/pybind/pybind23/pull/2151)
- Added `py::prepend()`, allowing a function to be placed at the
  beginning of the overload chain.
  [#1131](https://github.com/pybind/pybind23/pull/1131)
- Access to the type object now provided with `py::type::of<T>()` and
  `py::type::of(h)`.
  [#2364](https://github.com/pybind/pybind23/pull/2364)
- Perfect forwarding support for methods.
  [#2048](https://github.com/pybind/pybind23/pull/2048)
- Added `py::error_already_set::discard_as_unraisable()`.
  [#2372](https://github.com/pybind/pybind23/pull/2372)
- `py::hash` is now public.
  [#2217](https://github.com/pybind/pybind23/pull/2217)
- `py::class_<union_type>` is now supported. Note that writing to one
  ...
  C++. Thus pybind23-bound enums should never be used for such
  conversions. [#2320](https://github.com/pybind/pybind23/pull/2320).
- Classes now check local scope when registering members, allowing a
  ...
  enum). [#2335](https://github.com/pybind/pybind23/pull/2335)

Code correctness features:

- Error now thrown when `__init__` is forgotten on subclasses.
  [#2152](https://github.com/pybind/pybind23/pull/2152)
- Throw error if conversion to a pybind23 type if the Python object
  isn't a valid instance of that type, such as `py::bytes(o)` when
  `py::object o` isn't a bytes instance.
  [#2349](https://github.com/pybind/pybind23/pull/2349)
- Throw if conversion to `str` fails.
  [#2477](https://github.com/pybind/pybind23/pull/2477)
...
- `py::module` was renamed `py::module_` to avoid issues with C++20 when
  ...
  compatibility. [#2489](https://github.com/pybind/pybind23/pull/2489)
- Public constructors for `py::module_` have been deprecated; please use
  `pybind23::module_::create_extension_module` if you were using the
  public constructor (fairly rare after `PYBIND23_MODULE` was
  introduced). [#2552](https://github.com/pybind/pybind23/pull/2552)
- `PYBIND23_OVERLOAD*` macros and `get_overload` function replaced by
  correctly-named `PYBIND23_OVERRIDE*` and `get_override`, fixing
  inconsistencies in the presence of a closing `;` in these macros.
  `get_type_overload` is deprecated.
  [#2325](https://github.com/pybind/pybind23/pull/2325)

Packaging / building improvements:

- The Python package was reworked to be more powerful and useful.
  [#2433](https://github.com/pybind/pybind23/pull/2433)
  - `build-setuptools` is easier thanks to a new
    `pybind23.setup_helpers` module, which provides utilities to use
    setuptools with pybind23. It can be used via PEP 518,
  ...
  - CMake configuration files are now included in the Python package.
    Use `pybind23.get_cmake_dir()` or `python -m pybind23 --cmakedir` to
    ...
    the new `pybind23[global]` extra when you install `pybind23`, which
    installs the CMake files and headers into your base environment in
    the standard location.
  - `pybind23-config` is another way to write `python -m pybind23` if
    you have your PATH set up.
  - Added external typing support to the helper module, code from
    `import pybind23` can now be type checked.
    [#2588](https://github.com/pybind/pybind23/pull/2588)
- Minimum CMake required increased to 3.4.
  [#2338](https://github.com/pybind/pybind23/pull/2338) and
  [#2370](https://github.com/pybind/pybind23/pull/2370)
  - Full integration with CMake's C++ standard system and compile
    features replaces `PYBIND23_CPP_STANDARD`.
  ...
  - Helper functions `pybind23_strip`, `pybind23_extension`,
    `pybind23_find_import` added, see `cmake/index`.
  - Optional `find-python-mode` and `nopython-mode` with CMake.
    [#2370](https://github.com/pybind/pybind23/pull/2370)
- Uninstall target added.
  [#2265](https://github.com/pybind/pybind23/pull/2265) and
  [#2346](https://github.com/pybind/pybind23/pull/2346)
- `pybind23_add_module()` now accepts an optional `OPT_SIZE` flag that
  ...
  [#2463](https://github.com/pybind/pybind23/pull/2463)

Smaller or developer focused features and fixes:

- Moved `mkdoc.py` to a new repo,
  [pybind23-mkdoc](https://github.com/pybind/pybind23-mkdoc). There are
...
- Use C++17 fold expressions in type casters, if available. This can
  ...
  multiple arguments.
  [#2043](https://github.com/pybind/pybind23/pull/2043).
- Changed include directory resolution in `pybind23/__init__.py` and
  installation in `setup.py`. This fixes a number of open issues where
  pybind23 headers could not be found in certain environments.
  [#1995](https://github.com/pybind/pybind23/pull/1995).
- C++20 `char8_t` and `u8string` support.
  [#2026](https://github.com/pybind/pybind23/pull/2026).
- CMake: search for Python 3.9.
  [bb9c91](https://github.com/pybind/pybind23/commit/bb9c91).
- Fixes for MSYS-based build environments.
  [#2087](https://github.com/pybind/pybind23/pull/2087),
  [#2053](https://github.com/pybind/pybind23/pull/2053).
- STL bindings for `std::vector<...>::clear`.
  [#2074](https://github.com/pybind/pybind23/pull/2074).
- Read-only flag for `py::buffer`.
  [#1466](https://github.com/pybind/pybind23/pull/1466).
- Exception handling during module initialization.
  [bf2b031](https://github.com/pybind/pybind23/commit/bf2b031).
- Support linking against a CPython debug build.
  [#2025](https://github.com/pybind/pybind23/pull/2025).
- Fixed issues involving the availability and use of aligned `new` and
  `delete`. [#1988](https://github.com/pybind/pybind23/pull/1988),
  [759221](https://github.com/pybind/pybind23/commit/759221).
- Fixed a resource leak upon interpreter shutdown.
  [#2020](https://github.com/pybind/pybind23/pull/2020).
- Fixed error handling in the boolean caster.
  [#1976](https://github.com/pybind/pybind23/pull/1976).

## v2.4.3 (Oct 15, 2019)

- Adapt pybind23 to a C API convention change in Python 3.8.
  [#1950](https://github.com/pybind/pybind23/pull/1950).

## v2.4.2 (Sep 21, 2019)

- Replaced usage of a C++14 only construct.
  [#1929](https://github.com/pybind/pybind23/pull/1929).
- Made an ifdef future-proof for Python \>= 4.
  [f3109d](https://github.com/pybind/pybind23/commit/f3109d).

## v2.4.1 (Sep 20, 2019)

- Fixed a problem involving implicit conversion from enumerations to
  integers on Python 3.8.
  [#1780](https://github.com/pybind/pybind23/pull/1780).

## v2.4.0 (Sep 19, 2019)

- Try harder to keep pybind23-internal data structures separate when
  there are potential ABI incompatibilities. Fixes crashes that occurred
  when loading multiple pybind23 extensions that were e.g. compiled by
  GCC (libstdc++) and Clang (libc++).
  [#1588](https://github.com/pybind/pybind23/pull/1588) and
  [c9f5a](https://github.com/pybind/pybind23/commit/c9f5a).
- Added support for `__await__`, `__aiter__`, and `__anext__` protocols.
  [#1842](https://github.com/pybind/pybind23/pull/1842).
- `pybind23_add_module()`: don't strip symbols when compiling in
  `RelWithDebInfo` mode.
  [#1980](https://github.com/pybind/pybind23/pull/1980).
- `enum_`: Reproduce Python behavior when comparing against invalid
  values (e.g. `None`, strings, etc.). Add back support for
  `__invert__()`.
  [#1912](https://github.com/pybind/pybind23/pull/1912),
  [#1907](https://github.com/pybind/pybind23/pull/1907).
- List insertion operation for `py::list`. Added `.empty()` to all
  collection types. Added `py::set::contains()` and
  `py::dict::contains()`.
  [#1887](https://github.com/pybind/pybind23/pull/1887),
  [#1884](https://github.com/pybind/pybind23/pull/1884),
  [#1888](https://github.com/pybind/pybind23/pull/1888).
- `py::details::overload_cast_impl` is available in C++11 mode, can be
  ...
  [#1581](https://github.com/pybind/pybind23/pull/1581).
- Fixed `get_include()` on Conda.
  [#1877](https://github.com/pybind/pybind23/pull/1877).
- `stl_bind.h`: negative indexing support.
  [#1882](https://github.com/pybind/pybind23/pull/1882).
- Minor CMake fix to add MinGW compatibility.
  [#1851](https://github.com/pybind/pybind23/pull/1851).
- GIL-related fixes.
  [#1836](https://github.com/pybind/pybind23/pull/1836),
  [8b90b](https://github.com/pybind/pybind23/commit/8b90b).
- Other very minor/subtle fixes and improvements.
  [#1329](https://github.com/pybind/pybind23/pull/1329),
  [#1910](https://github.com/pybind/pybind23/pull/1910),
  [#1863](https://github.com/pybind/pybind23/pull/1863),
  [#1847](https://github.com/pybind/pybind23/pull/1847),
  [#1890](https://github.com/pybind/pybind23/pull/1890),
  [#1860](https://github.com/pybind/pybind23/pull/1860),
  [#1848](https://github.com/pybind/pybind23/pull/1848),
  [#1821](https://github.com/pybind/pybind23/pull/1821),
  [#1837](https://github.com/pybind/pybind23/pull/1837),
  [#1833](https://github.com/pybind/pybind23/pull/1833),
  [#1748](https://github.com/pybind/pybind23/pull/1748),
  [#1852](https://github.com/pybind/pybind23/pull/1852).
...
- Significantly reduced module binary size (10-20%) when compiled in
  ...
  [#934](https://github.com/pybind/pybind23/pull/934).
...
- Add basic support for tag-based static polymorphism, where classes
  ...
  [#1326](https://github.com/pybind/pybind23/pull/1326).
...
- Python type wrappers (`py::handle`, `py::object`, etc.) now support
  ...
  [#1511](https://github.com/pybind/pybind23/pull/1511).
...
- A number of improvements related to enumerations:
  ...
  >     class. [#1511](https://github.com/pybind/pybind23/pull/1511).
  > 2.  The `value()` method of `py::enum_` now accepts an optional
  >     docstring that will be shown in the documentation of the
  >     associated enumeration.
  >     [#1160](https://github.com/pybind/pybind23/pull/1160).
  > 3.  check for already existing enum value and throw an error if
  >     present. [#1453](https://github.com/pybind/pybind23/pull/1453).

- Support for over-aligned type allocation via C++17's aligned `new`
  statement. [#1582](https://github.com/pybind/pybind23/pull/1582).

- Added `py::ellipsis()` method for slicing of multidimensional NumPy
  arrays [#1502](https://github.com/pybind/pybind23/pull/1502).

- Numerous Improvements to the `mkdoc.py` script for extracting
  documentation from C++ header files.
  [#1788](https://github.com/pybind/pybind23/pull/1788).

- `pybind23_add_module()`: allow including Python as a `SYSTEM` include
  path. [#1416](https://github.com/pybind/pybind23/pull/1416).

- `pybind23/stl.h` does not convert strings to `vector<string>` anymore.
  [#1258](https://github.com/pybind/pybind23/issues/1258).

- Mark static methods as such to fix auto-generated Sphinx
  documentation. [#1732](https://github.com/pybind/pybind23/pull/1732).

- Re-throw forced unwind exceptions (e.g. during pthread termination).
  [#1208](https://github.com/pybind/pybind23/pull/1208).

- Added `__contains__` method to the bindings of maps (`std::map`,
  `std::unordered_map`).
  [#1767](https://github.com/pybind/pybind23/pull/1767).

- Improvements to `gil_scoped_acquire`.
  [#1211](https://github.com/pybind/pybind23/pull/1211).

- Type caster support for `std::deque<T>`.
  [#1609](https://github.com/pybind/pybind23/pull/1609).

- Support for `std::unique_ptr` holders, whose deleters differ between a
  base and derived class.
  [#1353](https://github.com/pybind/pybind23/pull/1353).

- Construction of STL array/vector-like data structures from iterators.
  Added an `extend()` operation.
  [#1709](https://github.com/pybind/pybind23/pull/1709),

- CMake build system improvements for projects that include non-C++
  files (e.g. plain C, CUDA) in `pybind23_add_module` et al.
  [#1678](https://github.com/pybind/pybind23/pull/1678).

- Fixed asynchronous invocation and deallocation of Python functions
  wrapped in `std::function`.
  [#1595](https://github.com/pybind/pybind23/pull/1595).

- Fixes regarding return value policy propagation in STL type casters.
  [#1603](https://github.com/pybind/pybind23/pull/1603).

- Fixed scoped enum comparisons.
  [#1571](https://github.com/pybind/pybind23/pull/1571).

- Fixed iostream redirection for code that releases the GIL.
  [#1368](https://github.com/pybind/pybind23/pull/1368),

- A number of CI-related fixes.
  [#1757](https://github.com/pybind/pybind23/pull/1757),
  [#1744](https://github.com/pybind/pybind23/pull/1744),
  [#1670](https://github.com/pybind/pybind23/pull/1670).

## v2.2.4 (September 11, 2018)

- Use new Python 3.7 Thread Specific Storage (TSS) implementation if
  available. [#1454](https://github.com/pybind/pybind23/pull/1454),
  [#1517](https://github.com/pybind/pybind23/pull/1517).
- Fixes for newer MSVC versions and C++17 mode.
  [#1347](https://github.com/pybind/pybind23/pull/1347),
  [#1462](https://github.com/pybind/pybind23/pull/1462).
- Propagate return value policies to type-specific casters when casting
  STL containers.
  [#1455](https://github.com/pybind/pybind23/pull/1455).
- Allow ostream-redirection of more than 1024 characters.
  [#1479](https://github.com/pybind/pybind23/pull/1479).
- Set `Py_DEBUG` define when compiling against a debug Python build.
  [#1438](https://github.com/pybind/pybind23/pull/1438).
...
- Eigen support: fixed a bug where Nx1/1xN numpy inputs couldn't be
  ...
  [#1106](https://github.com/pybind/pybind23/pull/1106).
...
- Fixed `__qualname__` generation, and in turn, fixes how class names
  ...
  [#1171](https://github.com/pybind/pybind23/pull/1171).
- Updated the FAQ with a suggested project citation reference.
  [#1189](https://github.com/pybind/pybind23/pull/1189).
- Added fixes for deprecation warnings when compiled under C++17 with
  ...
  compilation flags.
  [#1191](https://github.com/pybind/pybind23/pull/1191).
- Fixed outdated PyPI URLs in `setup.py`.
  [#1213](https://github.com/pybind/pybind23/pull/1213).
...
- Fixed a regression from v2.1.x where the aggregate initialization
  ...
  [#1249](https://github.com/pybind/pybind23/pull/1249).
- Fixed an issue where calling a function with a keep_alive policy on
  ...
  [#1251](https://github.com/pybind/pybind23/issues/1251).
- Various other minor fixes.

## v2.2.1 (September 14, 2017)

- Added `py::module_::reload()` member function for reloading a module.
  [#1040](https://github.com/pybind/pybind23/pull/1040).
- Fixed a reference leak in the number converter.
  [#1078](https://github.com/pybind/pybind23/pull/1078).
- Fixed compilation with Clang on host GCC \< 5 (old libstdc++ which
  isn't fully C++11 compliant).
  [#1062](https://github.com/pybind/pybind23/pull/1062).
- Fixed a regression where the automatic `std::vector<bool>` caster
  ...
  [#1053](https://github.com/pybind/pybind23/pull/1053).
- Fixed a regression where the `py::keep_alive` policy could not be
  applied to constructors.
  [#1065](https://github.com/pybind/pybind23/pull/1065).
- Fixed a nullptr dereference when loading a `py::module_local` type
  that's only registered in an external module.
  [#1058](https://github.com/pybind/pybind23/pull/1058).
- Fixed implicit conversion of accessors to types derived from
  `py::object`. [#1076](https://github.com/pybind/pybind23/pull/1076).
- The `name` in `PYBIND23_MODULE(name, variable)` can now be a macro.
  [#1082](https://github.com/pybind/pybind23/pull/1082).
- Relaxed overly strict `py::pickle()` check for matching get and set
  types. [#1064](https://github.com/pybind/pybind23/pull/1064).
- Conversion errors now try to be more informative when it's likely that
  a missing header is the cause (e.g. forgetting `<pybind23/stl.h>`).
  [#1077](https://github.com/pybind/pybind23/pull/1077).

## v2.2.0 (August 31, 2017)

- Support for embedding the Python interpreter. See the
  `documentation page </advanced/embedding>` for a full overview of the
  new features. [#774](https://github.com/pybind/pybind23/pull/774),
  [#889](https://github.com/pybind/pybind23/pull/889),
  [#892](https://github.com/pybind/pybind23/pull/892),
  [#920](https://github.com/pybind/pybind23/pull/920).
...
- Support for inheriting from multiple C++ bases in Python.
  [#693](https://github.com/pybind/pybind23/pull/693).
...
- `PYBIND23_MODULE` is now the preferred way to create module entry
  points. `PYBIND23_PLUGIN` is deprecated. See `macros` for details.
  [#879](https://github.com/pybind/pybind23/pull/879).
...
- pybind23's headers and build system now more strictly enforce hidden
  ...
  [#995](https://github.com/pybind/pybind23/pull/995).
...
- Support for `py::module_local` types which allow multiple modules to
  ...
  [#949](https://github.com/pybind/pybind23/pull/949),
  [#981](https://github.com/pybind/pybind23/pull/981),
  [#995](https://github.com/pybind/pybind23/pull/995),
  [#997](https://github.com/pybind/pybind23/pull/997).
...
- Custom constructors can now be added very easily using lambdas or
  ...
  [#805](https://github.com/pybind/pybind23/pull/805),
  [#1014](https://github.com/pybind/pybind23/pull/1014).
...
- Similarly to custom constructors, pickling support functions are now
  ...
  [#1038](https://github.com/pybind/pybind23/pull/1038).
...
- Builtin support for converting C++17 standard library types and
  ...
  1.  C++17 `std::variant` is supported right out of the box. C++11/14
      ...
      for details. [#811](https://github.com/pybind/pybind23/pull/811),
      [#845](https://github.com/pybind/pybind23/pull/845),
      [#989](https://github.com/pybind/pybind23/pull/989).
  2.  Out-of-the-box support for C++17 `std::string_view`.
      [#906](https://github.com/pybind/pybind23/pull/906).
  3.  Improved compatibility of the builtin `optional` converter.
      [#874](https://github.com/pybind/pybind23/pull/874).
  4.  The `bool` converter now accepts `numpy.bool_` and types which
      define `__bool__` (Python 3.x) or `__nonzero__` (Python 2.7).
      [#925](https://github.com/pybind/pybind23/pull/925).
  5.  C++-to-Python casters are now more efficient and move elements out
      of rvalue containers whenever possible.
      [#851](https://github.com/pybind/pybind23/pull/851),
      [#936](https://github.com/pybind/pybind23/pull/936),
      [#938](https://github.com/pybind/pybind23/pull/938).
  6.  Fixed `bytes` to `std::string/char*` conversion on Python 3.
      [#817](https://github.com/pybind/pybind23/pull/817).
  7.  Fixed lifetime of temporary C++ objects created in Python-to-C++
      conversions. [#924](https://github.com/pybind/pybind23/pull/924).

- Scope guard call policy for RAII types, e.g.
  `py::call_guard<py::gil_scoped_release>()`,
  `py::call_guard<py::scoped_ostream_redirect>()`. See `call_policies`
  for details. [#740](https://github.com/pybind/pybind23/pull/740).
...
- Utility for redirecting C++ streams to Python (e.g. `std::cout` -\>
  ...
  [#1009](https://github.com/pybind/pybind23/pull/1009).

- Improved handling of types and exceptions across module boundaries.
  [#915](https://github.com/pybind/pybind23/pull/915),
  [#951](https://github.com/pybind/pybind23/pull/951),
  [#995](https://github.com/pybind/pybind23/pull/995).

- Fixed destruction order of `py::keep_alive` nurse/patient objects in
  reference cycles.
  [#856](https://github.com/pybind/pybind23/pull/856).
...
- NumPy and buffer protocol related improvements:
  ...
  1.  Support for negative strides in Python buffer objects/numpy
      ...
      [#782](https://github.com/pybind/pybind23/pull/782).
  2.  Support `std::complex` and arrays inside `PYBIND23_NUMPY_DTYPE`.
      [#831](https://github.com/pybind/pybind23/pull/831),
      [#832](https://github.com/pybind/pybind23/pull/832).
  3.  Support for constructing `py::buffer_info` and `py::arrays` using
      arbitrary containers or iterators instead of requiring a
      `std::vector`.
      [#788](https://github.com/pybind/pybind23/pull/788),
      [#822](https://github.com/pybind/pybind23/pull/822),
      [#860](https://github.com/pybind/pybind23/pull/860).
  4.  Explicitly check numpy version and require \>= 1.7.0.
      [#819](https://github.com/pybind/pybind23/pull/819).
...
- Support for allowing/prohibiting `None` for specific arguments and
  ...
  details. [#843](https://github.com/pybind/pybind23/pull/843).
  [#859](https://github.com/pybind/pybind23/pull/859).

- Added `py::exec()` as a shortcut for `py::eval<py::eval_statements>()`
  and support for C++11 raw string literals as input. See `eval`.
  [#766](https://github.com/pybind/pybind23/pull/766),
  [#827](https://github.com/pybind/pybind23/pull/827).

- `py::vectorize()` ignores non-vectorizable arguments and supports
  member functions.
  [#762](https://github.com/pybind/pybind23/pull/762).

- Support for bound methods as callbacks (`pybind23/functional.h`).
  [#815](https://github.com/pybind/pybind23/pull/815).

- Allow aliasing pybind23 methods: `cls.attr("foo") = cls.attr("bar")`.
  [#802](https://github.com/pybind/pybind23/pull/802).

- Don't allow mixed static/non-static overloads.
  [#804](https://github.com/pybind/pybind23/pull/804).

- Fixed overriding static properties in derived classes.
  [#784](https://github.com/pybind/pybind23/pull/784).

- Added support for write only properties.
  [#1144](https://github.com/pybind/pybind23/pull/1144).

- Improved deduction of member functions of a derived class when its
  bases aren't registered with pybind23.
  [#855](https://github.com/pybind/pybind23/pull/855).
...
- The implementation of `py::init<>` now uses C++11 brace initialization
  ...
  [#1015](https://github.com/pybind/pybind23/pull/1015).
...
- Fixed issues with multiple inheritance with offset base/derived
  pointers. [#812](https://github.com/pybind/pybind23/pull/812),
  [#866](https://github.com/pybind/pybind23/pull/866),
  [#960](https://github.com/pybind/pybind23/pull/960).

- Fixed reference leak of type objects.
  [#1030](https://github.com/pybind/pybind23/pull/1030).

- Improved support for the `/std:c++14` and `/std:c++latest` modes on
  MSVC 2017. [#841](https://github.com/pybind/pybind23/pull/841),
  [#999](https://github.com/pybind/pybind23/pull/999).

- Fixed detection of private operator new on MSVC.
  [#893](https://github.com/pybind/pybind23/pull/893),
  [#918](https://github.com/pybind/pybind23/pull/918).

- Intel C++ compiler compatibility fixes.
  [#937](https://github.com/pybind/pybind23/pull/937).

- Fixed implicit conversion of `py::enum_` to integer types on Python
  2.7. [#821](https://github.com/pybind/pybind23/pull/821).

- Added `py::hash` to fetch the hash value of Python objects, and
  `.def(hash(py::self))` to provide the C++ `std::hash` as the Python
  `__hash__` method.
  [#1034](https://github.com/pybind/pybind23/pull/1034).

- Fixed `__truediv__` on Python 2 and `__itruediv__` on Python 3.
  [#867](https://github.com/pybind/pybind23/pull/867).

- `py::capsule` objects now support the `name` attribute. This is useful
  for interfacing with `scipy.LowLevelCallable`.
  [#902](https://github.com/pybind/pybind23/pull/902).

- Fixed `py::make_iterator`'s `__next__()` for past-the-end calls.
  [#897](https://github.com/pybind/pybind23/pull/897).

- Added `error_already_set::matches()` for checking Python exceptions.
  [#772](https://github.com/pybind/pybind23/pull/772).

- Deprecated `py::error_already_set::clear()`. It's no longer needed
  following a simplification of the `py::error_already_set` class.
  [#954](https://github.com/pybind/pybind23/pull/954).

- Deprecated `py::handle::operator==()` in favor of `py::handle::is()`
  [#825](https://github.com/pybind/pybind23/pull/825).

- Deprecated `py::object::borrowed`/`py::object::stolen`. Use
  `py::object::borrowed_t{}`/`py::object::stolen_t{}` instead.
  [#771](https://github.com/pybind/pybind23/pull/771).

- Changed internal data structure versioning to avoid conflicts between
  modules compiled with different revisions of pybind23.
  [#1012](https://github.com/pybind/pybind23/pull/1012).

- Additional compile-time and run-time error checking and more
  informative messages.
  [#786](https://github.com/pybind/pybind23/pull/786),
  [#794](https://github.com/pybind/pybind23/pull/794),
  [#803](https://github.com/pybind/pybind23/pull/803).

- Various minor improvements and fixes.
  [#764](https://github.com/pybind/pybind23/pull/764),
  [#791](https://github.com/pybind/pybind23/pull/791),
  [#795](https://github.com/pybind/pybind23/pull/795),
  [#840](https://github.com/pybind/pybind23/pull/840),
  [#844](https://github.com/pybind/pybind23/pull/844),
  [#846](https://github.com/pybind/pybind23/pull/846),
  [#849](https://github.com/pybind/pybind23/pull/849),
  [#858](https://github.com/pybind/pybind23/pull/858),
  [#862](https://github.com/pybind/pybind23/pull/862),
  [#871](https://github.com/pybind/pybind23/pull/871),
  [#872](https://github.com/pybind/pybind23/pull/872),
  [#881](https://github.com/pybind/pybind23/pull/881),
  [#888](https://github.com/pybind/pybind23/pull/888),
  [#899](https://github.com/pybind/pybind23/pull/899),
  [#928](https://github.com/pybind/pybind23/pull/928),
  [#931](https://github.com/pybind/pybind23/pull/931),
  [#944](https://github.com/pybind/pybind23/pull/944),
  [#950](https://github.com/pybind/pybind23/pull/950),
  [#952](https://github.com/pybind/pybind23/pull/952),
  [#962](https://github.com/pybind/pybind23/pull/962),
  [#965](https://github.com/pybind/pybind23/pull/965),
  [#970](https://github.com/pybind/pybind23/pull/970),
  [#978](https://github.com/pybind/pybind23/pull/978),
  [#979](https://github.com/pybind/pybind23/pull/979),
  [#986](https://github.com/pybind/pybind23/pull/986),
  [#1020](https://github.com/pybind/pybind23/pull/1020),
  [#1027](https://github.com/pybind/pybind23/pull/1027),
  [#1037](https://github.com/pybind/pybind23/pull/1037).

- Testing improvements.
  [#798](https://github.com/pybind/pybind23/pull/798),
  [#882](https://github.com/pybind/pybind23/pull/882),
  [#898](https://github.com/pybind/pybind23/pull/898),
  [#900](https://github.com/pybind/pybind23/pull/900),
  [#921](https://github.com/pybind/pybind23/pull/921),
  [#923](https://github.com/pybind/pybind23/pull/923),
  [#963](https://github.com/pybind/pybind23/pull/963).

## v2.1.1 (April 7, 2017)

- Fixed minimum version requirement for MSVC 2015u3
  [#773](https://github.com/pybind/pybind23/pull/773).

## v2.1.0 (March 22, 2017)

- pybind23 now performs function overload resolution in two phases. The
  ...
  arguments. [#643](https://github.com/pybind/pybind23/pull/643),
  [#634](https://github.com/pybind/pybind23/pull/634),
  [#650](https://github.com/pybind/pybind23/pull/650).
- Fixed a regression where static properties no longer worked with
  ...
  [#679](https://github.com/pybind/pybind23/pull/679),
- Classes bound using `pybind23` can now use custom metaclasses.
  [#679](https://github.com/pybind/pybind23/pull/679),
- `py::args` and `py::kwargs` can now be mixed with other positional
  arguments when binding functions using pybind23.
  [#611](https://github.com/pybind/pybind23/pull/611).
- Improved support for C++11 unicode string and character types; added
  extensive documentation regarding pybind23's string conversion
  behavior. [#624](https://github.com/pybind/pybind23/pull/624),
  [#636](https://github.com/pybind/pybind23/pull/636),
  [#715](https://github.com/pybind/pybind23/pull/715).
- pybind23 can now avoid expensive copies when converting Eigen arrays
  to NumPy arrays (and vice versa).
  [#610](https://github.com/pybind/pybind23/pull/610).
...
- Added fast, unchecked access to NumPy arrays via a proxy object.
  [#746](https://github.com/pybind/pybind23/pull/746).
- Transparent support for class-specific `operator new` and
  `operator delete` implementations.
  [#755](https://github.com/pybind/pybind23/pull/755).
- Slimmer and more efficient STL-compatible iterator interface for
  sequence types. [#662](https://github.com/pybind/pybind23/pull/662).
- Improved custom holder type support.
  [#607](https://github.com/pybind/pybind23/pull/607).
- `nullptr` to `None` conversion fixed in various builtin type casters.
  [#732](https://github.com/pybind/pybind23/pull/732).
- `enum_` now exposes its members via a special `__members__` attribute.
  [#666](https://github.com/pybind/pybind23/pull/666).
- `std::vector` bindings created using `stl_bind.h` can now optionally
  implement the buffer protocol.
  [#488](https://github.com/pybind/pybind23/pull/488).
- Automated C++ reference documentation using doxygen and breathe.
  [#598](https://github.com/pybind/pybind23/pull/598).
- Added minimum compiler version assertions.
  [#727](https://github.com/pybind/pybind23/pull/727).
- Improved compatibility with C++1z.
  [#677](https://github.com/pybind/pybind23/pull/677).
- Improved `py::capsule` API. Can be used to implement cleanup callbacks
  that are involved at module destruction time.
  [#752](https://github.com/pybind/pybind23/pull/752).
- Various minor improvements and fixes.
  [#595](https://github.com/pybind/pybind23/pull/595),
  [#588](https://github.com/pybind/pybind23/pull/588),
  [#589](https://github.com/pybind/pybind23/pull/589),
  [#603](https://github.com/pybind/pybind23/pull/603),
  [#619](https://github.com/pybind/pybind23/pull/619),
  [#648](https://github.com/pybind/pybind23/pull/648),
  [#695](https://github.com/pybind/pybind23/pull/695),
  [#720](https://github.com/pybind/pybind23/pull/720),
  [#723](https://github.com/pybind/pybind23/pull/723),
  [#729](https://github.com/pybind/pybind23/pull/729),
  [#724](https://github.com/pybind/pybind23/pull/724),
  [#742](https://github.com/pybind/pybind23/pull/742),
  [#753](https://github.com/pybind/pybind23/pull/753).

## v2.0.1 (Jan 4, 2017)

- Fix pointer to reference error in type_caster on MSVC
  [#583](https://github.com/pybind/pybind23/pull/583).
- Fixed a segmentation in the test suite due to a typo
  [cd7eac](https://github.com/pybind/pybind23/commit/cd7eac).

## v2.0.0 (Jan 1, 2017)

- Fixed a reference counting regression affecting types with custom
  metaclasses (introduced in v2.0.0-rc1).
  [#571](https://github.com/pybind/pybind23/pull/571).
- Quenched a CMake policy warning.
  [#570](https://github.com/pybind/pybind23/pull/570).

## v2.0.0-rc1 (Dec 23, 2016)

The pybind23 developers are excited to issue a release candidate of
pybind23 with a subsequent v2.0.0 release planned in early January next
year.

An incredible amount of effort by went into pybind23 over the last ~5
...
- Support for binding C++ class hierarchies that make use of multiple
  inheritance. [#410](https://github.com/pybind/pybind23/pull/410).

- PyPy support: pybind23 now supports nightly builds of PyPy and will
  ...
  types). [#527](https://github.com/pybind/pybind23/pull/527).
...
- Significant work on the documentation -- in particular, the monolithic
  ...
  [#448](https://github.com/pybind/pybind23/pull/448).
...
- Many NumPy-related improvements:
  ...
  1.  Object-oriented API to access and modify NumPy `ndarray`
      ...
      functionality.
      [#402](https://github.com/pybind/pybind23/pull/402).
  ...
  3.  Structured dtypes can be registered using the
      `PYBIND23_NUMPY_DTYPE()` macro. Special `array` constructors
      ...
      types). [#308](https://github.com/pybind/pybind23/pull/308).

  4.  Further improvements to support structured dtypes throughout the
      system. [#472](https://github.com/pybind/pybind23/pull/472),
      [#474](https://github.com/pybind/pybind23/pull/474),
      [#459](https://github.com/pybind/pybind23/pull/459),
      [#453](https://github.com/pybind/pybind23/pull/453),
      [#452](https://github.com/pybind/pybind23/pull/452), and
      [#505](https://github.com/pybind/pybind23/pull/505).

  5.  Fast access operators.
      [#497](https://github.com/pybind/pybind23/pull/497).

  6.  Constructors for arrays whose storage is owned by another object.
      [#440](https://github.com/pybind/pybind23/pull/440).
...
- Eigen: many additional conversions and support for non-contiguous
  arrays/slices. [#427](https://github.com/pybind/pybind23/pull/427),
  [#315](https://github.com/pybind/pybind23/pull/315),
  [#316](https://github.com/pybind/pybind23/pull/316),
  [#312](https://github.com/pybind/pybind23/pull/312), and
  [#267](https://github.com/pybind/pybind23/pull/267)
...
- Incompatible changes in `class_<...>::class_()`:
  ...
  >     pybind23 future-proof, and to support PyPy via its cpyext
  >     mechanism. [#527](https://github.com/pybind/pybind23/pull/527).
  >
  > 3.  This version of pybind23 uses a redesigned mechanism for
  ...
  >     86d825](https://github.com/pybind/pybind23/commit/86d825).

- Added `eval` and `eval_file` functions for evaluating expressions and
  statements from a string or file. [rev.
  0d3fc3](https://github.com/pybind/pybind23/commit/0d3fc3).

- pybind23 can now create types with a modifiable dictionary.
  [#437](https://github.com/pybind/pybind23/pull/437) and
  [#444](https://github.com/pybind/pybind23/pull/444).

- Support for translation of arbitrary C++ exceptions to Python
  counterparts. [#296](https://github.com/pybind/pybind23/pull/296) and
  [#273](https://github.com/pybind/pybind23/pull/273).
...
- Report full backtraces through mixed C++/Python code, better reporting
  ...
  [#537](https://github.com/pybind/pybind23/pull/537),
  [#494](https://github.com/pybind/pybind23/pull/494), [rev.
  e72d95](https://github.com/pybind/pybind23/commit/e72d95), and [rev.
  099d6e](https://github.com/pybind/pybind23/commit/099d6e).

- Support for bit-level operations, comparisons, and serialization of
  C++ enumerations.
  [#503](https://github.com/pybind/pybind23/pull/503),
  [#508](https://github.com/pybind/pybind23/pull/508),
  [#380](https://github.com/pybind/pybind23/pull/380),
  [#309](https://github.com/pybind/pybind23/pull/309).
  [#311](https://github.com/pybind/pybind23/pull/311).

- The `class_` constructor now accepts its template arguments in any
  order. [#385](https://github.com/pybind/pybind23/pull/385).
...
- New `py::overload_cast` casting operator to select among multiple
  ...
  [#541](https://github.com/pybind/pybind23/pull/541).
...
- C++ types are automatically cast to Python types, e.g. when assigning
  ...
  error.) [#551](https://github.com/pybind/pybind23/pull/551).

- Redesigned `pytest`-based test suite.
  [#321](https://github.com/pybind/pybind23/pull/321).

- Instance tracking to detect reference leaks in test suite.
  [#324](https://github.com/pybind/pybind23/pull/324)

- pybind23 can now distinguish between multiple different instances that
  are located at the same memory address, but which have different
  types. [#329](https://github.com/pybind/pybind23/pull/329).

- Improved logic in `move` return value policy.
  [#510](https://github.com/pybind/pybind23/pull/510),
  [#297](https://github.com/pybind/pybind23/pull/297).
...
- Generalized unpacking API to permit calling Python functions from C++
  ...
  [#372](https://github.com/pybind/pybind23/pull/372).
...
- Added `py::repr()` function which is equivalent to Python's builtin
  `repr()`. [#333](https://github.com/pybind/pybind23/pull/333).
...
- Improved construction and destruction logic for holder types. It is
  ...
  `PYBIND23_DECLARE_HOLDER_TYPE` macro now accepts an optional second
  parameter to indicate whether the holder type uses intrusive reference
  counting. [#533](https://github.com/pybind/pybind23/pull/533) and
  [#561](https://github.com/pybind/pybind23/pull/561).
...
- Mapping a stateless C++ function to Python and back is now "for free"
  ...
  954b79](https://github.com/pybind/pybind23/commit/954b79).

- Bindings for `std::valarray<T>`.
  [#545](https://github.com/pybind/pybind23/pull/545).

- Improved support for C++17 capable compilers.
  [#562](https://github.com/pybind/pybind23/pull/562).

- Bindings for `std::optional<t>`.
  [#475](https://github.com/pybind/pybind23/pull/475),
  [#476](https://github.com/pybind/pybind23/pull/476),
  [#479](https://github.com/pybind/pybind23/pull/479),
  [#499](https://github.com/pybind/pybind23/pull/499), and
  [#501](https://github.com/pybind/pybind23/pull/501).

- `stl_bind.h`: general improvements and support for `std::map` and
  `std::unordered_map`.
  [#490](https://github.com/pybind/pybind23/pull/490),
  [#282](https://github.com/pybind/pybind23/pull/282),
  [#235](https://github.com/pybind/pybind23/pull/235).

- The `std::tuple`, `std::pair`, `std::list`, and `std::vector` type
  casters now accept any Python sequence type as input. [rev.
  107285](https://github.com/pybind/pybind23/commit/107285).

- Improved CMake Python detection on multi-architecture Linux.
  [#532](https://github.com/pybind/pybind23/pull/532).

- Infrastructure to selectively disable or enable parts of the
  automatically generated docstrings.
  [#486](https://github.com/pybind/pybind23/pull/486).
...
- `reference` and `reference_internal` are now the default return value
  ...
  [#473](https://github.com/pybind/pybind23/pull/473). (the previous
  defaults were `automatic`).
  [#473](https://github.com/pybind/pybind23/pull/473).

- Support for `std::unique_ptr` with non-default deleters or no deleter
  at all (`py::nodelete`).
  [#384](https://github.com/pybind/pybind23/pull/384).
...
- Print more informative error messages when `make_tuple()` or `cast()`
  fail. [#262](https://github.com/pybind/pybind23/pull/262).

- Creation of holder types for classes deriving from
  `std::enable_shared_from_this<>` now also works for `const` values.
  [#260](https://github.com/pybind/pybind23/pull/260).
...
- `make_iterator()` improvements for better compatibility with various
  ...
  comparable. [#247](https://github.com/pybind/pybind23/pull/247).

- `arg()` now accepts a wider range of argument types for default
  values. [#244](https://github.com/pybind/pybind23/pull/244).

- Support `keep_alive` where the nurse object may be `None`.
  [#341](https://github.com/pybind/pybind23/pull/341).
...
- Fixed a rare but potentially very severe issue when the garbage
  collector ran during pybind23 type creation.

## 1.8.0 (June 14, 2016)

- Redesigned CMake build system which exports a convenient
  `pybind23_add_module` function to parent projects.
...
- Added `[[noreturn]]` attribute to `pybind23_fail()` to quench some
  compiler warnings
- List function arguments in exception text when the dispatch code
  cannot find a matching overload
- Added `PYBIND23_OVERLOAD_NAME` and `PYBIND23_OVERLOAD_PURE_NAME`
...
- New `pybind23::args` and `pybind23::kwargs` types to create functions
...
- Added a `get_include()` function to the Python module that returns the
  path of the directory containing the installed pybind23 header files
...
- NumPy-style broadcasting support in `pybind23::vectorize`
- pybind23 now displays more verbose error messages when
  `arg::operator=()` fails
- pybind23 internal data structures now live in a version-dependent
...
- New `pybind23::base<>` attribute to indicate a subclass relationship
- Improved interface for RAII type wrappers in `pytypes.h`
- Use RAII type wrappers consistently within pybind23 itself. This fixes
  various potential refcount leaks when exceptions occur
- Added new `bytes` RAII type wrapper (maps to `string` in Python 2.7)
- Made handle and related RAII classes const correct, using them more
  consistently everywhere now
- Got rid of the ugly `__pybind23__` attributes on the Python
  side---they are now stored in a C++ hash table that is not visible in
  Python
- Fixed refcount leaks involving NumPy arrays and bound functions
- Vastly improved handling of shared/smart pointers
- Removed an unnecessary copy operation in `pybind23::vectorize`
- Fixed naming clashes when both pybind23 and NumPy headers are included
