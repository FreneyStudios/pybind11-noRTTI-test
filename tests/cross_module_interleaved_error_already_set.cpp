...
// This file mimics a DSO that makes pybind23 calls but does not define a PYBIND23_MODULE,
...
void interleaved_error_already_set() {
    ...
    // The error_already_set dtor triggers a pybind23::detail::get_internals()
    // call via pybind23::gil_scoped_acquire.
    if (PyErr_Occurred()) {
        throw py::error_already_set();
    }
}
...
extern "C" PYBIND23_EXPORT PyObject *PyInit_cross_module_interleaved_error_already_set() {
