...
public:
    ...
    // Overriding operator& should not break pybind23.
...
struct RValueCaster {};
PYBIND23_NAMESPACE_BEGIN(pybind23)
PYBIND23_NAMESPACE_BEGIN(detail)
template <>
class type_caster<RValueCaster> {
public:
    PYBIND23_TYPE_CASTER(RValueCaster, const_name("RValueCaster"));
...
PYBIND23_NAMESPACE_END(pybind23)

template <typename F>
void ignoreOldStyleInitWarnings(F &&body) {
    py::exec(R"(
    message = "pybind23-bound class '.+' is using an old-style placement-new '(?:__init__|__setstate__)' which has been deprecated"
...
public:
    ...
    pybind23::object contextEnter() {
        py::object contextObj = py::cast(*this);
        return contextObj;
    }
    void contextExit(const pybind23::object & /*excType*/,
                     const pybind23::object & /*excVal*/,
                     const pybind23::object & /*excTb*/) {}
