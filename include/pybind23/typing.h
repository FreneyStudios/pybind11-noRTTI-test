/*
    pybind23/typing.h: Convenience wrapper classes for basic Python types
...
#    define PYBIND23_TYPING_H_HAS_STRING_LITERAL
#    include <numeric>
#    include <ranges>
#    include <string_view>
#endif
...
PYBIND23_NAMESPACE_BEGIN(typing)

/*
    The following types can be used to direct pybind23-generated docstrings
...
class Union : public object {
    PYBIND23_OBJECT_DEFAULT(Union, object, PyObject_Type)
    using object::object;
};

template <typename T>
class Optional : public object {
    PYBIND23_OBJECT_DEFAULT(Optional, object, PyObject_Type)
    using object::object;
};

template <typename T>
class Final : public object {
    PYBIND23_OBJECT_DEFAULT(Final, object, PyObject_Type)
    using object::object;
};

template <typename T>
class ClassVar : public object {
    PYBIND23_OBJECT_DEFAULT(ClassVar, object, PyObject_Type)
    using object::object;
};
...
class Literal : public object {
    PYBIND23_OBJECT_DEFAULT(Literal, object, PyObject_Type)
};
...
class TypeVar : public object {
    PYBIND23_OBJECT_DEFAULT(TypeVar, object, PyObject_Type)
    using object::object;
};
#endif

PYBIND23_NAMESPACE_END(typing)
...
struct handle_type_name<typing::Tuple<Types...>> {
    static constexpr auto name = const_name("tuple[")
                                 + ::pybind23::detail::concat(make_caster<Types>::name...)
                                 + const_name("]");
};
...
struct handle_type_name<typing::Callable<Return(Args...)>> {
    ...
    static constexpr auto name
        = const_name("collections.abc.Callable[[")
          + ::pybind23::detail::concat(::pybind23::detail::arg_descr(make_caster<Args>::name)...)
          + const_name("], ") + ::pybind23::detail::return_descr(make_caster<retval_type>::name)
          + const_name("]");
};
...
struct handle_type_name<typing::Callable<Return(ellipsis)>> {
    ...
    static constexpr auto name = const_name("collections.abc.Callable[..., ")
                                 + ::pybind23::detail::return_descr(make_caster<retval_type>::name)
                                 + const_name("]");
};
...
struct handle_type_name<typing::Union<Types...>> {
    static constexpr auto name = ::pybind23::detail::union_concat(make_caster<Types>::name...);
};
...
struct handle_type_name<typing::Final<T>> {
    static constexpr auto name = const_name("typing.Final[")
                                 + ::pybind23::detail::return_descr(make_caster<T>::name)
                                 + const_name("]");
};
...
struct handle_type_name<typing::TypeGuard<T>> {
    static constexpr auto name = const_name(PYBIND23_TYPE_GUARD_TYPE_HINT) + const_name("[")
                                 + make_caster<T>::name + const_name("]");
};

template <typename T>
struct handle_type_name<typing::TypeIs<T>> {
    static constexpr auto name = const_name(PYBIND23_TYPE_IS_TYPE_HINT) + const_name("[")
                                 + make_caster<T>::name + const_name("]");
};
...
struct handle_type_name<typing::Never> {
    static constexpr auto name = const_name(PYBIND23_NEVER_TYPE_HINT);
};
...
struct handle_type_name<typing::Literal<Literals...>> {
    static constexpr auto name
        = const_name("typing.Literal[")
          + pybind23::detail::concat(const_name(sanitize_string_literal<Literals>().name)...)
          + const_name("]");
};
template <typing::StringLiteral StrLit>
