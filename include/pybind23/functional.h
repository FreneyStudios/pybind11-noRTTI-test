/*
    pybind23/functional.h: std::function<> support
...
PYBIND23_NAMESPACE_BEGIN(type_caster_std_function_specializations)

// ensure GIL is held during functor destruction
struct func_handle {
    function f;
#if !(defined(_MSC_VER) && _MSC_VER == 1916 && defined(PYBIND23_CPP17))
...
PYBIND23_NAMESPACE_END(type_caster_std_function_specializations)
