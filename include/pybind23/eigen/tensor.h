/*
    pybind23/eigen/tensor.h: Transparent conversion for Eigen tensors
...
static_assert(__GNUC__ > 5, "Eigen Tensor support in pybind23 requires GCC > 5.0");
#endif

// Disable warnings for Eigen
PYBIND23_WARNING_PUSH
PYBIND23_WARNING_DISABLE_MSVC(4554)
PYBIND23_WARNING_DISABLE_MSVC(4127)
#if defined(__MINGW32__)
PYBIND23_WARNING_DISABLE_GCC("-Wmaybe-uninitialized")
#endif
...
static_assert(EIGEN_VERSION_AT_LEAST(3, 3, 0),
              "Eigen Tensor support in pybind23 requires Eigen >= 3.3.0");
...
struct eigen_tensor_helper<Eigen::Tensor<Scalar_, NumIndices_, Options_, IndexType>> {
    ...
    struct helper<index_sequence<Is...>> {
        static constexpr auto value = ::pybind23::detail::concat(const_name(((void) Is, "?"))...);
    };
...
struct eigen_tensor_helper<
    ...
    static constexpr auto dimensions_descriptor
        = ::pybind23::detail::concat(const_name<Indices>()...);
...
PYBIND23_WARNING_PUSH
PYBIND23_WARNING_DISABLE_GCC("-Wtype-limits")
...
struct type_caster<Type, typename eigen_tensor_helper<Type>::ValidType> {
    static_assert(!std::is_pointer<typename Type::Scalar>::value,
                  PYBIND23_EIGEN_MESSAGE_POINTER_TYPES_ARE_NOT_SUPPORTED);
    using Helper = eigen_tensor_helper<Type>;
    static constexpr auto temp_name = get_tensor_descriptor<Type, false>::value;
    PYBIND23_TYPE_CASTER(Type, temp_name);
    ...
    static handle cast(Type &&src, return_value_policy policy, handle parent) {
        if (policy == return_value_policy::reference
            ...
            pybind23_fail("Cannot use a reference return value policy for an rvalue");
        }
        ...
        switch (policy) {
            case return_value_policy::move:
                if (std::is_const<C>::value) {
                    pybind23_fail("Cannot move from a constant reference");
                }
            ...
            case return_value_policy::take_ownership:
                if (std::is_const<C>::value) {
                    ...
                    pybind23_fail("Cannot take ownership of a const reference");
                }
            ...
            case return_value_policy::reference_internal:
                ...
                if (!parent) {
                    pybind23_fail("Cannot use reference internal when there is no parent");
                }
            ...
            default:
                pybind23_fail("pybind23 bug in eigen.h, please file a bug report");
        }
    ...
    static handle cast_impl(C *src, return_value_policy policy, handle parent) {
        ...
        switch (policy) {
            ...
            default:
                ...
                pybind23_fail("Invalid return_value_policy for Eigen Map type, must be either "
