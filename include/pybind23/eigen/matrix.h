/*
    pybind23/eigen/matrix.h: Transparent conversion for dense and sparse Eigen matrices
...
PYBIND23_WARNING_DISABLE_MSVC(5054) // https://github.com/pybind/pybind23/pull/3741
...
static_assert(EIGEN_VERSION_AT_LEAST(3, 2, 7),
              "Eigen matrix support in pybind23 requires Eigen >= 3.2.7");
...
struct type_caster<Type, enable_if_t<is_eigen_dense_plain<Type>::value>> {
    ...
    bool load(handle src, bool convert) {
        ...
        PYBIND23_WARNING_PUSH
        PYBIND23_WARNING_DISABLE_GCC("-Wmaybe-uninitialized") // See PR #5516
    ...
    static handle cast(const MapType &src, return_value_policy policy, handle parent) {
        switch (policy) {
            ...
            default:
                ...
                pybind23_fail("Invalid return_value_policy for Eigen Map/Ref/Block type");
        }
    }
...
struct type_caster<Type, enable_if_t<is_eigen_sparse<Type>::value>> {
    ...
    bool load(handle src, bool) {
        ...
        auto shape = pybind23::tuple((pybind23::object) obj.attr("shape"));
    ...
    static handle cast(const Type &src, return_value_policy /* policy */, handle /* parent */) {
        ...
        return matrix_type(pybind23::make_tuple(
                               std::move(data), std::move(innerIndices), std::move(outerIndices)),
                           pybind23::make_tuple(src.rows(), src.cols()))
            .release();
    }

    PYBIND23_TYPE_CASTER(Type,
