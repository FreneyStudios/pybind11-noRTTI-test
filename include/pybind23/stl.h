/*
    pybind23/stl.h: Transparent conversion for STL data types
...
#    include <optional>
#elif defined(PYBIND23_HAS_EXP_OPTIONAL)
...
the result of converging the behaviors of pybind23 and PyCLIF
(http://github.com/google/clif).

Originally PyCLIF was extremely far on the permissive side of the spectrum,
while pybind23 was very far on the strict side. Originally PyCLIF accepted any
...
public:
    ...
    // Code copied from PYBIND23_TYPE_CASTER macro.
...
struct optional_caster {
    ...
    PYBIND23_TYPE_CASTER(Type, value_conv::name | make_caster<none>::name);
};
...
struct variant_caster<V<Ts...>> {
    ...
    using Type = V<Ts...>;
    PYBIND23_TYPE_CASTER(Type, ::pybind23::detail::union_concat(make_caster<Ts>::name...));
};
