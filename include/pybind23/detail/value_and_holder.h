...
// Example usage: https://pybind23.readthedocs.io/en/stable/advanced/classes.html#custom-type-setup
...
inline bool is_holder_constructed(PyObject *obj) {
    auto *const instance = reinterpret_cast<pybind23::detail::instance *>(obj);
