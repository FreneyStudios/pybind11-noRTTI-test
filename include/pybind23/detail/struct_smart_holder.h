...
struct guarded_delete {
    // NOTE: PYBIND23_INTERNALS_VERSION needs to be bumped if changes are made to this struct.
...
struct smart_holder {
    ...
    void ensure_use_count_1(const char *context) const {
        ...
        // is reached.
        // PYBIND23:REMINDER: This may need to be protected by a mutex in free-threaded Python.
        if (vptr.use_count() != 1) {
