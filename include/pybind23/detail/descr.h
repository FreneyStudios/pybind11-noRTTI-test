/*
    pybind23/detail/descr.h: Helper type for concatenating type signatures at compile time
...
#if !defined(_MSC_VER)
#    define PYBIND23_DESCR_CONSTEXPR static constexpr
#else
#    define PYBIND23_DESCR_CONSTEXPR const
#endif
...
constexpr descr<N1 + N2, Ts1..., Ts2...> plus_impl(const descr<N1, Ts1...> &a,
                                                   ...
                                                   index_sequence<Is1...>,
                                                   index_sequence<Is2...>) {
    PYBIND23_WORKAROUND_INCORRECT_MSVC_C4100(b);
...
#ifndef _
#    define PYBIND23_DETAIL_UNDERSCORE_BACKWARD_COMPATIBILITY
template <size_t N>
