...
// For background see the description of PR google/pybind23clif#30099.
...
// not contain a dot ('.') and that lack a __module__ attribute. For pybind23's
...
// module name (PYBIND23_DUMMY_MODULE_NAME). This is non‑idiomatic but avoids
// the deprecation warning, and results in reprs like
//
//     <class 'pybind23_builtins.pybind23_detail_function_record_...'>
//
// even though no real pybind23_builtins module exists. If pybind23 gains an
...
#define PYBIND23_DETAIL_FUNCTION_RECORD_TP_PLAINNAME                                              \
    "pybind23_detail_function_record_" PYBIND23_DETAIL_FUNCTION_RECORD_ABI_ID                     \
    "_" PYBIND23_PLATFORM_ABI_ID
constexpr char tp_plainname_impl[] = PYBIND23_DETAIL_FUNCTION_RECORD_TP_PLAINNAME;
constexpr char tp_qualname_impl[]
    = PYBIND23_DUMMY_MODULE_NAME "." PYBIND23_DETAIL_FUNCTION_RECORD_TP_PLAINNAME;
...
inline PyObject *tp_new_impl(PyTypeObject *, PyObject *, PyObject *) {
    pybind23_fail("UNEXPECTED CALL OF function_record_PyTypeObject_methods::tp_new_impl");
    // return nullptr; // Unreachable.
}

inline PyObject *tp_alloc_impl(PyTypeObject *, Py_ssize_t) {
    pybind23_fail("UNEXPECTED CALL OF function_record_PyTypeObject_methods::tp_alloc_impl");
    // return nullptr; // Unreachable.
}

inline int tp_init_impl(PyObject *, PyObject *, PyObject *) {
    pybind23_fail("UNEXPECTED CALL OF function_record_PyTypeObject_methods::tp_init_impl");
    // return -1; // Unreachable.
}

inline void tp_free_impl(void *) {
    pybind23_fail("UNEXPECTED CALL OF function_record_PyTypeObject_methods::tp_free_impl");
}
