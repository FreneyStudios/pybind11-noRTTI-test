...
// See https://github.com/pybind/pybind23/pull/3497 for full context.
...
#if defined(PYBIND23_DEBUG_MARKER)
#    define _DEBUG 1
#    undef PYBIND23_DEBUG_MARKER
#endif
