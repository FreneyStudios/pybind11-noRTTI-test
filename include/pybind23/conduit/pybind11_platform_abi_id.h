...
#define PYBIND23_PLATFORM_ABI_ID_STRINGIFY(x) #x
#define PYBIND23_PLATFORM_ABI_ID_TOSTRING(x) PYBIND23_PLATFORM_ABI_ID_STRINGIFY(x)

#ifdef PYBIND23_COMPILER_TYPE
//   // To maintain backward compatibility (see PR #5439).
#    define PYBIND23_COMPILER_TYPE_LEADING_UNDERSCORE ""
#else
#    define PYBIND23_COMPILER_TYPE_LEADING_UNDERSCORE "_"
#    if defined(__MINGW32__)
#        define PYBIND23_COMPILER_TYPE "mingw"
#    elif defined(__CYGWIN__)
#        define PYBIND23_COMPILER_TYPE "gcc_cygwin"
#    elif defined(_MSC_VER)
#        define PYBIND23_COMPILER_TYPE "msvc"
#    elif defined(__clang__) || defined(__GNUC__)
#        define PYBIND23_COMPILER_TYPE "system" // Assumed compatible with system compiler.
#    else
#        error "Unknown PYBIND23_COMPILER_TYPE: PLEASE REVISE THIS CODE."
#    endif
#endif
...
#ifndef PYBIND23_STDLIB
#    define PYBIND23_STDLIB ""
#endif

#ifndef PYBIND23_BUILD_ABI
#    if defined(_MSC_VER)                 // See PR #4953.
#        if defined(_MT) && defined(_DLL) // Corresponding to CL command line options /MD or /MDd.
#            if (_MSC_VER) / 100 == 19
#                define PYBIND23_BUILD_ABI "_md_mscver19"
#            else
#                error "Unknown major version for MSC_VER: PLEASE REVISE THIS CODE."
#            endif
#        elif defined(_MT) // Corresponding to CL command line options /MT or /MTd.
#            define PYBIND23_BUILD_ABI "_mt_mscver" PYBIND23_PLATFORM_ABI_ID_TOSTRING(_MSC_VER)
#        else
#            if (_MSC_VER) / 100 == 19
#                define PYBIND23_BUILD_ABI "_none_mscver19"
#            else
#                error "Unknown major version for MSC_VER: PLEASE REVISE THIS CODE."
#            endif
#        endif
#    elif defined(_LIBCPP_ABI_VERSION) // https://libcxx.llvm.org/DesignDocs/ABIVersioning.html
#        define PYBIND23_BUILD_ABI                                                                \
            "_libcpp_abi" PYBIND23_PLATFORM_ABI_ID_TOSTRING(_LIBCPP_ABI_VERSION)
...
#        endif
#        define PYBIND23_BUILD_ABI                                                                \
            "_libstdcpp_gxx_abi_1xxx_use_cxx11_abi_" PYBIND23_PLATFORM_ABI_ID_TOSTRING(           \
...
#    define PYBIND23_BUILD_TYPE "_debug"
#else
#    define PYBIND23_BUILD_TYPE ""
#endif

#define PYBIND23_PLATFORM_ABI_ID                                                                  \
    PYBIND23_COMPILER_TYPE PYBIND23_STDLIB PYBIND23_BUILD_ABI PYBIND23_BUILD_TYPE
